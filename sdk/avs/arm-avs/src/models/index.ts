...
export interface Addon extends Resource {
  ...
  licenseKey?: string;
  /**
   * The type of private cloud addon. Possible values include: 'SRM', 'VR'
   */
  addonType?: AddonType;
  /**
 ...
 * Possible values include: 'SRM', 'VR'
 * @readonly
 * @enum {string}
 */
export type AddonType = 'SRM' | 'VR';
 ...
 * @enum {string}
 */
export type AddonProvisioningState = 'Succeeded' | 'Failed' | 'Cancelled' | 'Deleting' | 'Updating';
