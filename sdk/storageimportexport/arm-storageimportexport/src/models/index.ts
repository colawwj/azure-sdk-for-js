 ...
 * Optional Parameters.
 */
export interface JobsListBySubscriptionNextOptionalParams extends msRest.RequestOptionsBase {
  /**
   * An integer value that specifies how many jobs at most should be returned. The value cannot
   * exceed 100.
   */
 ...
 * @enum {string}
 */
export type EncryptionKekType = 'MicrosoftManaged' | 'CustomerManaged';
