 ...
 * 'GPU', 'TCA_Large', 'EdgeP_Base', 'EdgeP_High', 'EdgePR_Base', 'EdgePR_Base_UPS', 'EdgeMR_Mini',
 * 'RCA_Small', 'RCA_Large', 'RDC'
 * @readonly
 * @enum {string}
 */
export type SkuName = 'Gateway' | 'Edge' | 'TEA_1Node' | 'TEA_1Node_UPS' | 'TEA_1Node_Heater' | 'TEA_1Node_UPS_Heater' | 'TEA_4Node_Heater' | 'TEA_4Node_UPS_Heater' | 'TMA' | 'TDC' | 'TCA_Small' | 'GPU' | 'TCA_Large' | 'EdgeP_Base' | 'EdgeP_High' | 'EdgePR_Base' | 'EdgePR_Base_UPS' | 'EdgeMR_Mini' | 'RCA_Small' | 'RCA_Large' | 'RDC';
