...
export class Triggers {
   ...
   */
  listByDataBoxEdgeDeviceNext(nextPageLink: string, options?: Models.TriggersListByDataBoxEdgeDeviceNextOptionalParams): Promise<Models.TriggersListByDataBoxEdgeDeviceNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listByDataBoxEdgeDeviceNext(nextPageLink: string, options: Models.TriggersListByDataBoxEdgeDeviceNextOptionalParams, callback: msRest.ServiceCallback<Models.TriggerList>): void;
  listByDataBoxEdgeDeviceNext(nextPageLink: string, options?: Models.TriggersListByDataBoxEdgeDeviceNextOptionalParams | msRest.ServiceCallback<Models.TriggerList>, callback?: msRest.ServiceCallback<Models.TriggerList>): Promise<Models.TriggersListByDataBoxEdgeDeviceNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
