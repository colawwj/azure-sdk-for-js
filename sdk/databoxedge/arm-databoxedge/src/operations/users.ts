...
export class Users {
   ...
   */
  listByDataBoxEdgeDeviceNext(nextPageLink: string, options?: Models.UsersListByDataBoxEdgeDeviceNextOptionalParams): Promise<Models.UsersListByDataBoxEdgeDeviceNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listByDataBoxEdgeDeviceNext(nextPageLink: string, options: Models.UsersListByDataBoxEdgeDeviceNextOptionalParams, callback: msRest.ServiceCallback<Models.UserList>): void;
  listByDataBoxEdgeDeviceNext(nextPageLink: string, options?: Models.UsersListByDataBoxEdgeDeviceNextOptionalParams | msRest.ServiceCallback<Models.UserList>, callback?: msRest.ServiceCallback<Models.UserList>): Promise<Models.UsersListByDataBoxEdgeDeviceNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
