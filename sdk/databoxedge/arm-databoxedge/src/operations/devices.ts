...
export class Devices {
   ...
   * @param resourceGroupName The resource group name.
   * @param [options] The optional parameters
   * @returns Promise<Models.DevicesGenerateCertificateResponse>
   */
  generateCertificate(deviceName: string, resourceGroupName: string, options?: msRest.RequestOptionsBase): Promise<Models.DevicesGenerateCertificateResponse>;
  /**
   * @param deviceName The device name.
   * @param resourceGroupName The resource group name.
   * @param callback The callback
   */
  generateCertificate(deviceName: string, resourceGroupName: string, callback: msRest.ServiceCallback<Models.GenerateCertResponse>): void;
  /**
   * @param deviceName The device name.
   * @param resourceGroupName The resource group name.
   * @param options The optional parameters
   * @param callback The callback
   */
  generateCertificate(deviceName: string, resourceGroupName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.GenerateCertResponse>): void;
  generateCertificate(deviceName: string, resourceGroupName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.GenerateCertResponse>, callback?: msRest.ServiceCallback<Models.GenerateCertResponse>): Promise<Models.DevicesGenerateCertificateResponse> {
    return this.client.sendOperationRequest(
      {
        deviceName,
        resourceGroupName,
      ...
      callback) as Promise<Models.DevicesGenerateCertificateResponse>;
  }
   ...
   * @param resourceGroupName The resource group name.
   * @param [options] The optional parameters
   * @returns Promise<Models.DevicesUpdateExtendedInformationResponse>
   */
  updateExtendedInformation(deviceName: string, parameters: Models.DataBoxEdgeDeviceExtendedInfoPatch, resourceGroupName: string, options?: msRest.RequestOptionsBase): Promise<Models.DevicesUpdateExtendedInformationResponse>;
  /**
   * @param deviceName The device name.
   * @param parameters The patch object.
   * @param resourceGroupName The resource group name.
   * @param callback The callback
   */
  updateExtendedInformation(deviceName: string, parameters: Models.DataBoxEdgeDeviceExtendedInfoPatch, resourceGroupName: string, callback: msRest.ServiceCallback<Models.DataBoxEdgeDeviceExtendedInfo>): void;
  /**
   * @param deviceName The device name.
   * @param parameters The patch object.
   * @param resourceGroupName The resource group name.
   ...
   * @param callback The callback
   */
  updateExtendedInformation(deviceName: string, parameters: Models.DataBoxEdgeDeviceExtendedInfoPatch, resourceGroupName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.DataBoxEdgeDeviceExtendedInfo>): void;
  updateExtendedInformation(deviceName: string, parameters: Models.DataBoxEdgeDeviceExtendedInfoPatch, resourceGroupName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.DataBoxEdgeDeviceExtendedInfo>, callback?: msRest.ServiceCallback<Models.DataBoxEdgeDeviceExtendedInfo>): Promise<Models.DevicesUpdateExtendedInformationResponse> {
    return this.client.sendOperationRequest(
      {
        deviceName,
        parameters,
      ...
      callback) as Promise<Models.DevicesUpdateExtendedInformationResponse>;
  }
   ...
   */
  listBySubscriptionNext(nextPageLink: string, options?: Models.DevicesListBySubscriptionNextOptionalParams): Promise<Models.DevicesListBySubscriptionNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listBySubscriptionNext(nextPageLink: string, options: Models.DevicesListBySubscriptionNextOptionalParams, callback: msRest.ServiceCallback<Models.DataBoxEdgeDeviceList>): void;
  listBySubscriptionNext(nextPageLink: string, options?: Models.DevicesListBySubscriptionNextOptionalParams | msRest.ServiceCallback<Models.DataBoxEdgeDeviceList>, callback?: msRest.ServiceCallback<Models.DataBoxEdgeDeviceList>): Promise<Models.DevicesListBySubscriptionNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
   ...
   */
  listByResourceGroupNext(nextPageLink: string, options?: Models.DevicesListByResourceGroupNextOptionalParams): Promise<Models.DevicesListByResourceGroupNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listByResourceGroupNext(nextPageLink: string, options: Models.DevicesListByResourceGroupNextOptionalParams, callback: msRest.ServiceCallback<Models.DataBoxEdgeDeviceList>): void;
  listByResourceGroupNext(nextPageLink: string, options?: Models.DevicesListByResourceGroupNextOptionalParams | msRest.ServiceCallback<Models.DataBoxEdgeDeviceList>, callback?: msRest.ServiceCallback<Models.DataBoxEdgeDeviceList>): Promise<Models.DevicesListByResourceGroupNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
...
const generateCertificateOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
...
const updateExtendedInformationOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
  ...
  requestBody: {
    parameterPath: "parameters",
    mapper: {
      ...Mappers.DataBoxEdgeDeviceExtendedInfoPatch,
      required: true
    }
  },
  responses: {
