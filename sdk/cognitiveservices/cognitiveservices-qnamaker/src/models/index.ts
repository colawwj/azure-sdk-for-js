...
export interface QueryDTO {
  ...
  top?: number;
  /**
   * Unique identifier for the user. Optional parameter for telemetry. For more information, refer
   * <a href="http://aka.ms/qnamaker-analytics#user-traffic" target="blank">Analytics and
   * Telemetry.</a>
   */
  userId?: string;
  /**
