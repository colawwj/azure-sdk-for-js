...
export interface JobExtendedInfo {
   ...
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly dataTransferedInBytes?: number;
  /**
...
export interface AzureBackupJob {
  ...
  /**
   * A List, detatiling the errors related to the job
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
   ...
   * Retention:Backup/Archive ; Management:ConfigureProtection/UnConfigure
   */
  operation: string;
  /**
   * It indicates the type of Job i.e. Backup/Restore/Retention/Management
   */
  ...
  /**
   * Name of the Datasource's Resource Group
   */
...
export interface DataStoreInfoBase {
  /**
   * type of datastore; SnapShot/Hot/Archive. Possible values include: 'ArchiveStore',
   * 'SnapshotStore', 'VaultStore'
   */
...
export interface ScheduleBasedBackupCriteria {
  ...
  /**
   * It should be Fisrt/Second/Third/Fourth/Last
   */
 ...
 * @summary ResourceOperationGateKeeperResource
 */
export interface ResourceOperationGateKeeperResource extends DppTrackedResource {
  /**
   * Provisioning state of the resource. Possible values include: 'Failed', 'Provisioning',
   ...
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly lastLockUpdateTime?: Date;
}
 ...
 * @summary ResourceOperationGateKeeperResourceList
 * @extends Array<ResourceOperationGateKeeperResource>, DppResourceList
 */
export interface ResourceOperationGateKeeperResourceList extends Array<ResourceOperationGateKeeperResource>, DppResourceList {
}
 ...
 * @enum {string}
 */
export type DataStoreTypes = 'ArchiveStore' | 'SnapshotStore' | 'VaultStore';
 ...
 * Contains response data for the getResourcesInSubscription operation.
 */
export type ResourceOperationGatekeepersGetResourcesInSubscriptionResponse = ResourceOperationGateKeeperResourceList & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: ResourceOperationGateKeeperResourceList;
    };
};
 ...
 * Contains response data for the getResourcesInResourceGroup operation.
 */
export type ResourceOperationGatekeepersGetResourcesInResourceGroupResponse = ResourceOperationGateKeeperResourceList & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the get operation.
 */
export type ResourceOperationGatekeepersGetResponse = ResourceOperationGateKeeperResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: ResourceOperationGateKeeperResource;
    };
};
 ...
 * Contains response data for the put operation.
 */
export type ResourceOperationGatekeepersPutResponse = ResourceOperationGateKeeperResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the patch operation.
 */
export type ResourceOperationGatekeepersPatchResponse = ResourceOperationGateKeeperResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the getResourcesInSubscriptionNext operation.
 */
export type ResourceOperationGatekeepersGetResourcesInSubscriptionNextResponse = ResourceOperationGateKeeperResourceList & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the getResourcesInResourceGroupNext operation.
 */
export type ResourceOperationGatekeepersGetResourcesInResourceGroupNextResponse = ResourceOperationGateKeeperResourceList & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
