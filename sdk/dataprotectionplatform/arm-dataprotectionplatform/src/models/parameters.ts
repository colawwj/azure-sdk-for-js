...
export const resourceOperationGateKeepersName: msRest.OperationURLParameter = {
  parameterPath: "resourceOperationGateKeepersName",
  mapper: {
    required: true,
