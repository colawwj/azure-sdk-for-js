 ...
 */
export interface HybridCertificate extends ProxyResource {
  /**
 ...
 * Contains response data for the createOrUpdate operation.
 */
export type HybridCertificateCreateOrUpdateResponse = HybridCertificate & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export type HybridCertificateBeginCreateOrUpdateResponse = HybridCertificate & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
