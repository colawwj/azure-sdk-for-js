...
export class TenantAccess {
   ...
   */
  create(resourceGroupName: string, serviceName: string, parameters: Models.AccessInformationUpdateParameters, accessName: Models.AccessIdName, ifMatch: string, options?: msRest.RequestOptionsBase): Promise<Models.TenantAccessCreateResponse>;
  /**
   * @param resourceGroupName The name of the resource group.
   * @param serviceName The name of the API Management service.
   * @param parameters Parameters supplied to retrieve the Tenant Access Information.
   ...
   * @param callback The callback
   */
  create(resourceGroupName: string, serviceName: string, parameters: Models.AccessInformationUpdateParameters, accessName: Models.AccessIdName, ifMatch: string, callback: msRest.ServiceCallback<Models.AccessInformationContract>): void;
  /**
   * @param resourceGroupName The name of the resource group.
   * @param serviceName The name of the API Management service.
   * @param parameters Parameters supplied to retrieve the Tenant Access Information.
   ...
   * @param callback The callback
   */
  create(resourceGroupName: string, serviceName: string, parameters: Models.AccessInformationUpdateParameters, accessName: Models.AccessIdName, ifMatch: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.AccessInformationContract>): void;
  create(resourceGroupName: string, serviceName: string, parameters: Models.AccessInformationUpdateParameters, accessName: Models.AccessIdName, ifMatch: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.AccessInformationContract>, callback?: msRest.ServiceCallback<Models.AccessInformationContract>): Promise<Models.TenantAccessCreateResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        serviceName,
   ...
   */
  listByServiceNext(nextPageLink: string, options?: msRest.RequestOptionsBase): Promise<Models.TenantAccessListByServiceNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listByServiceNext(nextPageLink: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.AccessInformationCollection>): void;
  listByServiceNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.AccessInformationCollection>, callback?: msRest.ServiceCallback<Models.AccessInformationCollection>): Promise<Models.TenantAccessListByServiceNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
