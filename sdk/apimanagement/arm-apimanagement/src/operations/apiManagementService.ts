...
export class ApiManagementService {
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.ApiManagementServiceGetDomainOwnershipIdentifierResponse>
   */
  getDomainOwnershipIdentifier(options?: msRest.RequestOptionsBase): Promise<Models.ApiManagementServiceGetDomainOwnershipIdentifierResponse>;
  /**
   * @param callback The callback
   */
  getDomainOwnershipIdentifier(callback: msRest.ServiceCallback<Models.ApiManagementServiceGetDomainOwnershipIdentifierResult>): void;
  /**
   * @param options The optional parameters
   * @param callback The callback
   */
  getDomainOwnershipIdentifier(options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.ApiManagementServiceGetDomainOwnershipIdentifierResult>): void;
  getDomainOwnershipIdentifier(options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ApiManagementServiceGetDomainOwnershipIdentifierResult>, callback?: msRest.ServiceCallback<Models.ApiManagementServiceGetDomainOwnershipIdentifierResult>): Promise<Models.ApiManagementServiceGetDomainOwnershipIdentifierResponse> {
    return this.client.sendOperationRequest(
      {
        options
      },
      getDomainOwnershipIdentifierOperationSpec,
      callback) as Promise<Models.ApiManagementServiceGetDomainOwnershipIdentifierResponse>;
  }
