...
export class AssessmentsMetadata {
   ...
   * @param assessmentMetadataName The Assessment Key - Unique key for the assessment type
   * @param [options] The optional parameters
   * @returns Promise<Models.AssessmentsMetadataGetMetadataInSubscriptionResponse>
   */
  getMetadataInSubscription(assessmentMetadataName: string, options?: msRest.RequestOptionsBase): Promise<Models.AssessmentsMetadataGetMetadataInSubscriptionResponse>;
  /**
   * @param assessmentMetadataName The Assessment Key - Unique key for the assessment type
   * @param callback The callback
   */
  getMetadataInSubscription(assessmentMetadataName: string, callback: msRest.ServiceCallback<Models.SecurityAssessmentMetadata>): void;
  /**
   * @param assessmentMetadataName The Assessment Key - Unique key for the assessment type
   * @param options The optional parameters
   * @param callback The callback
   */
  getMetadataInSubscription(assessmentMetadataName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.SecurityAssessmentMetadata>): void;
  getMetadataInSubscription(assessmentMetadataName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.SecurityAssessmentMetadata>, callback?: msRest.ServiceCallback<Models.SecurityAssessmentMetadata>): Promise<Models.AssessmentsMetadataGetMetadataInSubscriptionResponse> {
    return this.client.sendOperationRequest(
      {
        assessmentMetadataName,
        options
      },
      getMetadataInSubscriptionOperationSpec,
      callback) as Promise<Models.AssessmentsMetadataGetMetadataInSubscriptionResponse>;
  }
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.AssessmentsMetadataCreateOrUpdateResponse>
   */
  createOrUpdate(assessmentMetadataName: string, assessmentMetadata: Models.SecurityAssessmentMetadata, options?: msRest.RequestOptionsBase): Promise<Models.AssessmentsMetadataCreateOrUpdateResponse>;
  /**
   * @param assessmentMetadataName The Assessment Key - Unique key for the assessment type
   * @param assessmentMetadata AssessmentMetadata object
   * @param callback The callback
   */
  createOrUpdate(assessmentMetadataName: string, assessmentMetadata: Models.SecurityAssessmentMetadata, callback: msRest.ServiceCallback<Models.SecurityAssessmentMetadata>): void;
  /**
   * @param assessmentMetadataName The Assessment Key - Unique key for the assessment type
   * @param assessmentMetadata AssessmentMetadata object
   * @param options The optional parameters
   * @param callback The callback
   */
  createOrUpdate(assessmentMetadataName: string, assessmentMetadata: Models.SecurityAssessmentMetadata, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.SecurityAssessmentMetadata>): void;
  createOrUpdate(assessmentMetadataName: string, assessmentMetadata: Models.SecurityAssessmentMetadata, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.SecurityAssessmentMetadata>, callback?: msRest.ServiceCallback<Models.SecurityAssessmentMetadata>): Promise<Models.AssessmentsMetadataCreateOrUpdateResponse> {
    return this.client.sendOperationRequest(
      {
        assessmentMetadataName,
        assessmentMetadata,
      ...
      callback) as Promise<Models.AssessmentsMetadataCreateOrUpdateResponse>;
  }
...
const getMetadataInSubscriptionOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
