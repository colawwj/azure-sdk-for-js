...
export class RegulatoryComplianceAssessments {
   ...
   */
  listNext(nextPageLink: string, options?: Models.RegulatoryComplianceAssessmentsListNextOptionalParams): Promise<Models.RegulatoryComplianceAssessmentsListNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listNext(nextPageLink: string, options: Models.RegulatoryComplianceAssessmentsListNextOptionalParams, callback: msRest.ServiceCallback<Models.RegulatoryComplianceAssessmentList>): void;
  listNext(nextPageLink: string, options?: Models.RegulatoryComplianceAssessmentsListNextOptionalParams | msRest.ServiceCallback<Models.RegulatoryComplianceAssessmentList>, callback?: msRest.ServiceCallback<Models.RegulatoryComplianceAssessmentList>): Promise<Models.RegulatoryComplianceAssessmentsListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
