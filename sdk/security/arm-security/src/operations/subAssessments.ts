...
export class SubAssessments {
   ...
   */
  list(scope: string, options?: msRest.RequestOptionsBase): Promise<Models.SubAssessmentsListResponse>;
  /**
   * @param scope Scope of the query, can be subscription
   * (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group
   * (/providers/Microsoft.Management/managementGroups/mgName).
   ...
   */
  list(scope: string, callback: msRest.ServiceCallback<Models.SecuritySubAssessmentList>): void;
  /**
   * @param scope Scope of the query, can be subscription
   * (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group
   * (/providers/Microsoft.Management/managementGroups/mgName).
   ...
   * @param callback The callback
   */
  list(scope: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.SecuritySubAssessmentList>): void;
  list(scope: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.SecuritySubAssessmentList>, callback?: msRest.ServiceCallback<Models.SecuritySubAssessmentList>): Promise<Models.SubAssessmentsListResponse> {
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.SubAssessmentsListByAssessmentResponse>
   */
  listByAssessment(scope: string, assessmentName: string, options?: msRest.RequestOptionsBase): Promise<Models.SubAssessmentsListByAssessmentResponse>;
  /**
   * @param scope Scope of the query, can be subscription
   * (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group
   * (/providers/Microsoft.Management/managementGroups/mgName).
   ...
   * @param callback The callback
   */
  listByAssessment(scope: string, assessmentName: string, callback: msRest.ServiceCallback<Models.SecuritySubAssessmentList>): void;
  /**
   * @param scope Scope of the query, can be subscription
   * (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group
   * (/providers/Microsoft.Management/managementGroups/mgName).
   ...
   * @param callback The callback
   */
  listByAssessment(scope: string, assessmentName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.SecuritySubAssessmentList>): void;
  listByAssessment(scope: string, assessmentName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.SecuritySubAssessmentList>, callback?: msRest.ServiceCallback<Models.SecuritySubAssessmentList>): Promise<Models.SubAssessmentsListByAssessmentResponse> {
    return this.client.sendOperationRequest(
      {
        scope,
        assessmentName,
      ...
      callback) as Promise<Models.SubAssessmentsListByAssessmentResponse>;
  }
   ...
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param [options] The optional parameters
   * @returns Promise<Models.SubAssessmentsListByAssessmentNextResponse>
   */
  listByAssessmentNext(nextPageLink: string, options?: msRest.RequestOptionsBase): Promise<Models.SubAssessmentsListByAssessmentNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
  listByAssessmentNext(nextPageLink: string, callback: msRest.ServiceCallback<Models.SecuritySubAssessmentList>): void;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param options The optional parameters
   * @param callback The callback
   */
  listByAssessmentNext(nextPageLink: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.SecuritySubAssessmentList>): void;
  listByAssessmentNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.SecuritySubAssessmentList>, callback?: msRest.ServiceCallback<Models.SecuritySubAssessmentList>): Promise<Models.SubAssessmentsListByAssessmentNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
      ...
      callback) as Promise<Models.SubAssessmentsListByAssessmentNextResponse>;
  }
}
...
const listByAssessmentNextOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
  baseUrl: "https://management.azure.com",
  path: "{nextLink}",
  urlParameters: [
