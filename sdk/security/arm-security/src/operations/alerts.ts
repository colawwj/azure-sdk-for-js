...
export class Alerts {
   ...
   * @returns Promise<msRest.RestResponse>
   */
  simulateAlerts(alertSimulatorRequestBody: Models.AlertSimulatorRequestBody, options?: msRest.RequestOptionsBase): Promise<msRest.RestResponse>;
  /**
   * @param alertSimulatorRequestBody Alert Simulator Request Properties
   * @param callback The callback
   */
  simulateAlerts(alertSimulatorRequestBody: Models.AlertSimulatorRequestBody, callback: msRest.ServiceCallback<void>): void;
  /**
   * @param alertSimulatorRequestBody Alert Simulator Request Properties
   * @param options The optional parameters
   * @param callback The callback
   */
  simulateAlerts(alertSimulatorRequestBody: Models.AlertSimulatorRequestBody, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<void>): void;
  simulateAlerts(alertSimulatorRequestBody: Models.AlertSimulatorRequestBody, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<void>, callback?: msRest.ServiceCallback<void>): Promise<msRest.RestResponse> {
    return this.client.sendOperationRequest(
      {
        alertSimulatorRequestBody,
        options
      },
      simulateAlertsOperationSpec,
      callback);
  }
...
const simulateAlertsOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
