...
export class IotDefenderSettings {
  ...
  /**
   * Download on-premise sensors activation file
   * @param [options] The optional parameters
   * @returns Promise<msRest.RestResponse>
   */
  downloadOnPremiseActivation(options?: msRest.RequestOptionsBase): Promise<msRest.RestResponse>;
  /**
   * @param callback The callback
   */
  downloadOnPremiseActivation(callback: msRest.ServiceCallback<void>): void;
  /**
   * @param options The optional parameters
   * @param callback The callback
   */
  downloadOnPremiseActivation(options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<void>): void;
  downloadOnPremiseActivation(options?: msRest.RequestOptionsBase | msRest.ServiceCallback<void>, callback?: msRest.ServiceCallback<void>): Promise<msRest.RestResponse> {
    return this.client.sendOperationRequest(
      {
        options
      },
      downloadOnPremiseActivationOperationSpec,
      callback);
  }
}
...
const downloadOnPremiseActivationOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
  path: "subscriptions/{subscriptionId}/providers/Microsoft.Security/iotDefenderSettings/default/downloadOnPremiseActivation",
  urlParameters: [
    Parameters.subscriptionId
  ],
  queryParameters: [
