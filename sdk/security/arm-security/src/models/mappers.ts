...
export const IoTDeviceEntityAzureResource: msRest.CompositeMapper = {
  serializedName: "IoTDeviceEntity_azureResource",
  type: {
    name: "Composite",
    className: "IoTDeviceEntityAzureResource",
    modelProperties: {
      resourceId: {
        serializedName: "ResourceId",
        type: {
...
export const IPEntity: msRest.CompositeMapper = {
  ...
  type: {
    name: "Composite",
    polymorphicDiscriminator: AlertEntity.type.polymorphicDiscriminator,
    uberParent: "AlertEntity",
    className: "IPEntity",
    modelProperties: {
      ...AlertEntity.type.modelProperties,
      address: {
    ...
    additionalProperties: AlertEntity.type.additionalProperties
  }
};
...
export const AlertsEntity: msRest.CompositeMapper = {
  serializedName: "alerts",
  type: {
    name: "Composite",
    polymorphicDiscriminator: AlertEntity.type.polymorphicDiscriminator,
    uberParent: "AlertEntity",
    className: "AlertsEntity",
    modelProperties: {
      ...AlertEntity.type.modelProperties,
      displayName: {
        serializedName: "displayName",
...
export const CloudApplicationEntity: msRest.CompositeMapper = {
  serializedName: "cloud-application",
  type: {
    name: "Composite",
    polymorphicDiscriminator: AlertEntity.type.polymorphicDiscriminator,
    uberParent: "AlertEntity",
...
export const FileHashEntity: msRest.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...AlertEntity.type.modelProperties,
      fileHashAlgorithm: {
        serializedName: "fileHashAlgorithm",
        type: {
          name: "String"
        }
      },
...
export const HostLogonSessionEntity: msRest.CompositeMapper = {
  serializedName: "host-logon-session",
  type: {
    name: "Composite",
    polymorphicDiscriminator: AlertEntity.type.polymorphicDiscriminator,
    uberParent: "AlertEntity",
    className: "HostLogonSessionEntity",
    modelProperties: {
      ...AlertEntity.type.modelProperties,
      sessionId: {
...
export const NetworkConnectionEntity: msRest.CompositeMapper = {
  serializedName: "network-connection",
  type: {
    name: "Composite",
    polymorphicDiscriminator: AlertEntity.type.polymorphicDiscriminator,
    uberParent: "AlertEntity",
    className: "NetworkConnectionEntity",
    modelProperties: {
      ...AlertEntity.type.modelProperties,
      sourceAddress: {
...
export const discriminators = {
  ...
  'AlertEntity.ip' : IPEntity,
  'AlertEntity.iotdevice' : IoTDeviceEntity,
  'AlertEntity.host' : HostEntity,
  'AlertEntity.account' : AccountEntity,
  'AlertEntity.alerts' : AlertsEntity,
  'AlertEntity.cloud-application' : CloudApplicationEntity,
  'AlertEntity.dns' : DnsEntity,
  'AlertEntity.filehash' : FileHashEntity,
  'AlertEntity.file' : FileEntity,
  'AlertEntity.host-logon-session' : HostLogonSessionEntity,
  'AlertEntity.mailbox' : MailboxEntity,
  'AlertEntity.process' : ProcessEntity,
  'AlertEntity.malware' : MalwareEntity,
  'AlertEntity.network-connection' : NetworkConnectionEntity,
  'AlertEntity.registry-key' : RegistryKeyEntity,
  'AlertEntity.registry-value' : RegistryValueEntity,
  'AlertEntity.security-group' : SecurityGroupEntity,
