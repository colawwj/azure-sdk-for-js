...
export const AssessmentResourceDetails: msRest.CompositeMapper = {
  serializedName: "AssessmentResourceDetails",
  type: {
    name: "Composite",
    polymorphicDiscriminator: {
      serializedName: "Source",
    ...
    uberParent: "AssessmentResourceDetails",
    className: "AssessmentResourceDetails",
    modelProperties: {
      source: {
        required: true,
        serializedName: "Source",
...
export const AssessmentAzureResourceDetails: msRest.CompositeMapper = {
  serializedName: "Azure",
  type: {
    name: "Composite",
    polymorphicDiscriminator: AssessmentResourceDetails.type.polymorphicDiscriminator,
    uberParent: "AssessmentResourceDetails",
    className: "AssessmentAzureResourceDetails",
    modelProperties: {
      ...AssessmentResourceDetails.type.modelProperties,
      id: {
        readOnly: true,
        serializedName: "Id",
        type: {
...
export const AssessmentAwsResourceDetails: msRest.CompositeMapper = {
  serializedName: "Aws",
  type: {
    name: "Composite",
    polymorphicDiscriminator: AssessmentResourceDetails.type.polymorphicDiscriminator,
    uberParent: "AssessmentResourceDetails",
    className: "AssessmentAwsResourceDetails",
    modelProperties: {
      ...AssessmentResourceDetails.type.modelProperties,
      accountId: {
        required: true,
...
export const AssessmentGcpResourceDetails: msRest.CompositeMapper = {
  serializedName: "Gcp",
  type: {
    name: "Composite",
    polymorphicDiscriminator: AssessmentResourceDetails.type.polymorphicDiscriminator,
    uberParent: "AssessmentResourceDetails",
    className: "AssessmentGcpResourceDetails",
    modelProperties: {
      ...AssessmentResourceDetails.type.modelProperties,
      projectId: {
        required: true,
...
export const AssessmentOnPremiseResourceDetails: msRest.CompositeMapper = {
  serializedName: "OnPremise",
  type: {
    name: "Composite",
    polymorphicDiscriminator: AssessmentResourceDetails.type.polymorphicDiscriminator,
    uberParent: "AssessmentResourceDetails",
    className: "AssessmentOnPremiseResourceDetails",
    modelProperties: {
      ...AssessmentResourceDetails.type.modelProperties,
      workspaceId: {
        required: true,
...
export const Device: msRest.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...
      sensorName: {
        readOnly: true,
        serializedName: "properties.sensorName",
        type: {
          name: "String"
        }
      },
      ...
      zoneName: {
        readOnly: true,
        serializedName: "properties.zoneName",
        type: {
          name: "String"
        }
      },
...
export const discriminators = {
  ...
  'AssessmentResourceDetails' : AssessmentResourceDetails,
  'AssessmentResourceDetails.Azure' : AssessmentAzureResourceDetails,
  'AssessmentResourceDetails.Aws' : AssessmentAwsResourceDetails,
  'AssessmentResourceDetails.Gcp' : AssessmentGcpResourceDetails,
  'AssessmentResourceDetails.OnPremise' : AssessmentOnPremiseResourceDetails,
