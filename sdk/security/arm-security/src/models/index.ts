...
export interface AutomationSource {
   ...
   * 'SecureScores', 'SecureScoreControls'
   */
...
/**
 * Contains the possible cases for AlertEntity.
 */
export type AlertEntityUnion = AlertEntity | IPEntity | IoTDeviceEntity | HostEntity | AccountEntity | AlertsEntity | CloudApplicationEntity | DnsEntity | FileHashEntity | FileEntity | HostLogonSessionEntity | MailboxEntity | ProcessEntity | MalwareEntity | NetworkConnectionEntity | RegistryKeyEntity | RegistryValueEntity | SecurityGroupEntity;
...
export interface Alert extends Resource {
  ...
  /**
   * Manual actions to take to remediate the alert.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly remediationSteps?: string[];
  /**
  ...
  readonly vendorName?: string;
  /**
   * The lifecycle status of the alert. Possible values include: 'Active', 'Resolved', 'Dismissed'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  ...
  /**
   * A direct link to the alert page in the Azure portal.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  ...
  /**
   * The name of the product which published this alert (Azure Security Center, Microsoft Defender
   * for Identity, Microsoft Defender for Endpoint, Microsoft Defender for Office 365, MCAS, and so
   * on).
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly productName?: string;
   ...
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly entities?: AlertEntityUnion[];
  /**
  ...
  /**
   * Key for correlating related alerts. Alerts with the same correlation key are considered as
   * related.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 */
export interface IoTDeviceEntityAzureResource {
  resourceId?: string;
}
...
export interface IoTDeviceEntity {
   ...
   * ARM ID of for connected IoT Hub
   */
  azureResource?: IoTDeviceEntityAzureResource;
  /**
  ...
  macAddress?: string;
  /**
   * The communication protocols the device is using
   */
  protocols?: string[];
  /**
  ...
  serialNumber?: string;
  /**
   * The source of the device entity
   */
  source?: string;
  /**
   * URL reference to the source item where the device is managed
   */
  sourceRef?: string;
  /**
...
export interface HostEntity {
  ...
  type: "host";
  /**
   * The DNS domain to which this computer belongs.
   */
  dnsDomain?: string;
  /**
   * The NT domain to which this computer belongs.
   */
  ntDomain?: string;
  /**
   * The NT domain to which this computer belongs.
  ...
  hostName?: string;
  /**
   * The computer name (pre-windows2000).
   */
  netBiosName?: string;
  /**
  ...
  azureID?: string;
  /**
   * The OMS agent ID, if the computer has OMS agent installed.
   */
  omsAgentID?: string;
  /**
  ...
  osFamily?: string;
  /**
   * The computer operating system specific version. This is a free form textual representation of
   * the OS.
   */
  osVersion?: string;
...
/**
 * Represents an account. The account can be either a domain account, a local account, or an AAD
 * account.
 */
export interface AccountEntity {
  ...
  name?: string;
  /**
   * The NETBIOS domain name – domain\username.
   */
  ntDomain?: string;
  /**
...
export interface AlertsEntity {
  ...
  type: "alerts";
  /**
   * The display name for the related alert.
   */
  displayName?: string;
  /**
   * The display name of the compromised entity for the alert.
   */
  compromisedEntity?: string;
  /**
   * The number of related alerts grouped into the incident.
   */
  count?: number;
  /**
   * The related alert severity.
   */
  severity?: string;
  /**
   * The related alert type.
   */
  alertType?: string;
  /**
   * The related alert vendor name.
   */
  vendorName?: string;
  /**
   * The related alerts identifiers.
   */
...
export interface CloudApplicationEntity {
  ...
  name?: string;
  /**
   * The user defined instance name of the cloud application.
   */
  instanceName?: string;
}
...
export interface DnsEntity {
  ...
  domainName?: string;
  /**
   * Entities of type ‘ip’ for the resolved IP address.
   */
  ipAddresses?: IPEntity[];
  dnsServerIp?: IPEntity;
  hostIpAddress?: IPEntity;
}

/**
 * Represents a file hash value that is reported as part of the security detection alert, usually
 * in relation to some file entity instance.
 */
...
export interface FileEntity {
  ...
  type: "file";
  /**
   * The file's full path, combining both directory and name.
   */
  fullPath?: string;
  /**
  ...
  host?: HostEntity;
  /**
   * The file hashes associated with this file.
   */
  fileHashes?: FileHashEntity[];
}

/**
 * Represents a logon session to a host by an account.
 */
export interface HostLogonSessionEntity {
  /**
   * Polymorphic Discriminator
   */
...
export interface MailboxEntity {
  ...
  upn?: string;
  /**
   * External directory object identifier of the mailbox
   */
  externalDirectoryObjectId?: string;
  /**
   * The risk level of this mailbox like Low, Medium, High
   */
  riskLevel?: string;
}
...
export interface ProcessEntity {
  ...
  account?: AccountEntity;
  logonSession?: HostLogonSessionEntity;
...
export interface MalwareEntity {
  ...
  category?: string;
  /**
   * Holds list of File entities which relate to this Malware entity instance
   */
  files?: FileEntity[];
  /**
   * Holds list of Process entities which relate to this Malware entity instance
   */
  processes?: ProcessEntity[];
}

/**
 * An interface representing NetworkConnectionEntity.
 */
export interface NetworkConnectionEntity {
  ...
  sourceAddress?: IPEntity;
  /**
   * The source port number
   */
  sourcePort?: number;
  destinationAddress?: IPEntity;
  /**
   * The destination port number
   */
  destinationPort?: number;
  /**
   * The protocol type of the network connection (i.e. TCP, UDP)
   */
  protocol?: string;
}
...
export interface RegistryValueEntity {
   ...
   */
  type: "registry-value";
  key?: RegistryKeyEntity;
  /**
   * The registry key entity
   */
  name?: string;
  /**
...
/**
 * Represents a security group that is reported as part of the security detection alert. The
...
export interface LogAnalyticsIdentifier {
  ...
  type: "LogAnalytics";
  /**
   * The Log Analytics workspace ID that stores this alert.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly workspaceId?: string;
  /**
   * The Azure subscription ID for the Log Analytics workspace storing this alert.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly workspaceSubscriptionId?: string;
  /**
   * The Azure resource group for the Log Analytics workspace storing this alert
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly workspaceResourceGroup?: string;
  /**
   * (optional) The Log Analytics agent ID reporting the event that this alert is based on.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 * IoT alert
 */
export interface IotAlertModel {
  /**
   * Holds the product canonical identifier of the alert within the scope of a product
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 * @interface
 * List of IoT alerts
 * @extends Array<IotAlertModel>
 */
export interface IotAlertListModel extends Array<IotAlertModel> {
  /**
   * When available, follow the URI to get the next page of data
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 * @interface
 * List of IoT recommendations
 * @extends Array<IotRecommendationModel>
 */
export interface IotRecommendationListModel extends Array<IotRecommendationModel> {
  /**
   * When available, follow the URI to get the next page of data
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 * @enum {string}
 */
export type EventSource = 'Assessments' | 'SubAssessments' | 'Alerts' | 'SecureScores' | 'SecureScoreControls';
