...
export interface AutomationSource {
   ...
   * 'SecureScores', 'SecureScoresSnapshot', 'SecureScoreControls', 'SecureScoreControlsSnapshot',
 ...
 */
export interface InsightsModel extends Resource {
  /**
  ...
  /**
   * Describes the insight.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly insightDescription?: string;
  /**
   * A bag of objects which provides the insights information
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly insightProperties?: any;
}
 ...
 * @extends Array<InsightsModel>
 */
export interface InsightsList extends Array<InsightsModel> {
  /**
   * The URI to fetch the next page.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 * @enum {string}
 */
export type EventSource = 'Assessments' | 'SubAssessments' | 'Alerts' | 'SecureScores' | 'SecureScoresSnapshot' | 'SecureScoreControls' | 'SecureScoreControlsSnapshot' | 'RegulatoryComplianceAssessment' | 'RegulatoryComplianceAssessmentSnapshot';
 ...
 * Contains response data for the list operation.
 */
export type InsightsListResponse = InsightsList & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the get operation.
 */
export type InsightsGetResponse = InsightsModel & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listNext operation.
 */
export type InsightsListNextResponse = InsightsList & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
