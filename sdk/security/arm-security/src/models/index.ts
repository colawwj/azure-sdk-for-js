...
export interface AlertSimulatorRequestBody {
  /**
   * Alert Simulator request body data. Default value: {}.
   */
 ...
 * Possible values include: 'AppServices', 'KeyVaults', 'KubernetesService', 'SqlServers',
 * 'StorageAccounts', 'VirtualMachines'
 * @readonly
 * @enum {string}
 */
export type BundleType = 'AppServices' | 'KeyVaults' | 'KubernetesService' | 'SqlServers' | 'StorageAccounts' | 'VirtualMachines';
