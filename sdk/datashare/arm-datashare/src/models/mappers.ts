...
export const discriminators = {
  'BaseResource.DataSet' : DataSet,
  'BaseResource.DataSetMapping' : DataSetMapping,
  'SourceShareSynchronizationSetting' : SourceShareSynchronizationSetting,
  'BaseResource.SynchronizationSetting' : SynchronizationSetting,
  'BaseResource.Trigger' : Trigger,
  'BaseResource.ScheduleBased' : ScheduledSynchronizationSetting,
  'BaseResource.ScheduleBased' : ScheduledTrigger,
  'BaseResource.Blob' : BlobDataSet,
  'BaseResource.BlobFolder' : BlobFolderDataSet,
  'BaseResource.Container' : BlobContainerDataSet,
  'BaseResource.AdlsGen2File' : ADLSGen2FileDataSet,
  'BaseResource.AdlsGen2Folder' : ADLSGen2FolderDataSet,
  'BaseResource.AdlsGen2FileSystem' : ADLSGen2FileSystemDataSet,
  'BaseResource.AdlsGen1Folder' : ADLSGen1FolderDataSet,
  'BaseResource.AdlsGen1File' : ADLSGen1FileDataSet,
  'BaseResource.KustoCluster' : KustoClusterDataSet,
  'BaseResource.KustoDatabase' : KustoDatabaseDataSet,
  'BaseResource.SqlDWTable' : SqlDWTableDataSet,
  'BaseResource.SqlDBTable' : SqlDBTableDataSet,
  'BaseResource.Blob' : BlobDataSetMapping,
  'BaseResource.BlobFolder' : BlobFolderDataSetMapping,
  'BaseResource.Container' : BlobContainerDataSetMapping,
  'BaseResource.AdlsGen2File' : ADLSGen2FileDataSetMapping,
  'BaseResource.AdlsGen2Folder' : ADLSGen2FolderDataSetMapping,
  'BaseResource.AdlsGen2FileSystem' : ADLSGen2FileSystemDataSetMapping,
  'BaseResource.KustoCluster' : KustoClusterDataSetMapping,
  'BaseResource.KustoDatabase' : KustoDatabaseDataSetMapping,
  'BaseResource.SqlDWTable' : SqlDWTableDataSetMapping,
  'BaseResource.SqlDBTable' : SqlDBTableDataSetMapping,
