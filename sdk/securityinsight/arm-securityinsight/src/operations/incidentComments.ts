...
export class IncidentComments {
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.IncidentCommentsCreateOrUpdateCommentResponse>
   */
  createOrUpdateComment(resourceGroupName: string, workspaceName: string, incidentId: string, incidentCommentId: string, incidentComment: Models.IncidentComment, options?: msRest.RequestOptionsBase): Promise<Models.IncidentCommentsCreateOrUpdateCommentResponse>;
  /**
   * @param resourceGroupName The name of the resource group within the user's subscription. The name
   * is case insensitive.
   * @param workspaceName The name of the workspace.
   ...
   * @param callback The callback
   */
  createOrUpdateComment(resourceGroupName: string, workspaceName: string, incidentId: string, incidentCommentId: string, incidentComment: Models.IncidentComment, callback: msRest.ServiceCallback<Models.IncidentComment>): void;
  /**
   * @param resourceGroupName The name of the resource group within the user's subscription. The name
   * is case insensitive.
   * @param workspaceName The name of the workspace.
   ...
   * @param callback The callback
   */
  createOrUpdateComment(resourceGroupName: string, workspaceName: string, incidentId: string, incidentCommentId: string, incidentComment: Models.IncidentComment, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.IncidentComment>): void;
  createOrUpdateComment(resourceGroupName: string, workspaceName: string, incidentId: string, incidentCommentId: string, incidentComment: Models.IncidentComment, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.IncidentComment>, callback?: msRest.ServiceCallback<Models.IncidentComment>): Promise<Models.IncidentCommentsCreateOrUpdateCommentResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        workspaceName,
      ...
      createOrUpdateCommentOperationSpec,
      callback) as Promise<Models.IncidentCommentsCreateOrUpdateCommentResponse>;
  }
   ...
   */
  deleteComment(resourceGroupName: string, workspaceName: string, incidentId: string, incidentCommentId: string, options?: msRest.RequestOptionsBase): Promise<msRest.RestResponse>;
  /**
   * @param resourceGroupName The name of the resource group within the user's subscription. The name
   * is case insensitive.
   * @param workspaceName The name of the workspace.
   ...
   * @param callback The callback
   */
  deleteComment(resourceGroupName: string, workspaceName: string, incidentId: string, incidentCommentId: string, callback: msRest.ServiceCallback<void>): void;
  /**
   * @param resourceGroupName The name of the resource group within the user's subscription. The name
   * is case insensitive.
   * @param workspaceName The name of the workspace.
   ...
   * @param callback The callback
   */
  deleteComment(resourceGroupName: string, workspaceName: string, incidentId: string, incidentCommentId: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<void>): void;
  deleteComment(resourceGroupName: string, workspaceName: string, incidentId: string, incidentCommentId: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<void>, callback?: msRest.ServiceCallback<void>): Promise<msRest.RestResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        workspaceName,
...
const createOrUpdateCommentOperationSpec: msRest.OperationSpec = {
  httpMethod: "PUT",
  path: "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/incidents/{incidentId}/comments/{incidentCommentId}",
  urlParameters: [
    Parameters.subscriptionId,
