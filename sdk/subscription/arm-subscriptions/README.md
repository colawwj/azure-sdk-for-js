...
#### nodejs - Authentication, client creation and get operationResults as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  client.operationResults.get(operationId).then((result) => {
...
#### browser - Authentication, client creation and get operationResults as an example written in JavaScript.
