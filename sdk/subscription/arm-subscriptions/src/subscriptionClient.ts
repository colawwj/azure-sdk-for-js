...
class SubscriptionClient extends SubscriptionClientContext {
  ...
  subscriptionPolicy: operations.SubscriptionPolicy;
  billingAccount: operations.BillingAccount;
  ...
  constructor(credentials: msRest.ServiceClientCredentials, options?: Models.SubscriptionClientOptions) {
    ...
    this.subscriptionPolicy = new operations.SubscriptionPolicy(this);
    this.billingAccount = new operations.BillingAccount(this);
  }
}
