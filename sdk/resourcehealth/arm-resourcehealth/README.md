...
#### nodejs - client creation and listBySubscriptionId events as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  const view = "testview";
  client.events.listBySubscriptionId(filter, view).then((result) => {
...
#### browser - Authentication, client creation and listBySubscriptionId events as an example written in JavaScript.
