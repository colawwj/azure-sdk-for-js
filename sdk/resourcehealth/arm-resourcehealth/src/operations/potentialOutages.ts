...
const getOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
  path: "providers/Microsoft.ResourceHealth/potentialOutages/{potentialOutageName}",
  urlParameters: [
    Parameters.potentialOutageName
  ],
  queryParameters: [
  ...
  responses: {
    ...
    default: {
      bodyMapper: Mappers.PotentialOutageErrorResponse
    }
  },
  serializer
};
