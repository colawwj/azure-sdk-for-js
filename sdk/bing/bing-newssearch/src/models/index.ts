...
export interface NewsSearchOptionalParams extends msRest.RequestOptionsBase {
   ...
   * [setLang](https://docs.microsoft.com/en-us/bing/bing-news-search/overview) query parameter are
   * mutually exclusive; do not specify both. If you set this header, you must also specify the
   * [cc](https://docs.microsoft.com/en-us/bing/bing-news-search/overview) query parameter. To
   ...
   * [mkt](https://docs.microsoft.com/en-us/bing/bing-news-search/overview) and
   * [setLang](https://docs.microsoft.com/en-us/bing/bing-news-search/overview) query parameters. A
   * user interface string is a string that's used as a label in a user interface. There are few
   ...
   * values, see [Market Codes](https://docs.microsoft.com/en-us/bing/bing-news-search/overview).
   ...
   * Codes](https://docs.microsoft.com/en-us/bing/bing-news-search/overview), Bing uses a best fit
   * market code based on an internal mapping that is subject to change. This parameter and the
   * [cc](https://docs.microsoft.com/en-us/bing/bing-news-search/overview) query parameter are
   ...
   * ([totalEstimatedMatches](https://docs.microsoft.com/en-us/bing/bing-news-search/overview) -
   ...
   * [Accept-Language](https://docs.microsoft.com/en-us/bing/bing-news-search/overview) header are
   ...
   * [textFormat](https://docs.microsoft.com/en-us/bing/bing-news-search/overview) query parameter.
   * For information about hit highlighting, see [Hit
   * Highlighting](https://docs.microsoft.com/en-us/bing/bing-news-search/overview).
   */
...
export interface NewsCategoryOptionalParams extends msRest.RequestOptionsBase {
   ...
   * Market](https://docs.microsoft.com/en-us/bing/bing-news-search/overview). Use this parameter
   * only with News Category API. If you do not specify this parameter, the response includes both:
   ...
   * headline field is set to true. By default, the response includes up to 12 headline articles.
   * To specify the number of headline articles to return, set the
   * [headlineCount](https://docs.microsoft.com/en-us/bing/bing-news-search/overview) query
   * parameter.
   */
  category?: string;
  /**
   ...
   * [category](https://docs.microsoft.com/en-us/bing/bing-news-search/overview) parameter, Bing
   ...
   * [category](https://docs.microsoft.com/en-us/bing/bing-news-search/overview) parameter.
   */
   ...
   * specify the [category](https://docs.microsoft.com/en-us/bing/bing-news-search/overview)
