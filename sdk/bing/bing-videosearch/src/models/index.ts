...
export interface VideosSearchOptionalParams extends msRest.RequestOptionsBase {
   ...
   * [setLang](https://docs.microsoft.com/en-us/bing/bing-video-search/overview) query parameter
   * are mutually exclusive; do not specify both. If you set this header, you must also specify the
   * [cc](https://docs.microsoft.com/en-us/bing/bing-video-search/overview) query parameter. To
   ...
   * [mkt](https://docs.microsoft.com/en-us/bing/bing-video-search/overview) and
   * [setLang](https://docs.microsoft.com/en-us/bing/bing-video-search/overview) query parameters.
   ...
   * [Video](https://docs.microsoft.com/en-us/bing/bing-video-search/overview) object's videoId
   * field contains the ID that you set this parameter to. You use this parameter to ensure that
   ...
   * values, see [Market Codes](https://docs.microsoft.com/en-us/bing/bing-video-search/overview).
   ...
   * Codes](https://docs.microsoft.com/en-us/bing/bing-video-search/overview), Bing uses a best fit
   * market code based on an internal mapping that is subject to change. This parameter and the
   * [cc](https://docs.microsoft.com/en-us/bing/bing-video-search/overview) query parameter are
   ...
   * ([totalEstimatedMatches](https://docs.microsoft.com/en-us/bing/bing-video-search/overview) -
   ...
   * duplicates, see
   * [nextOffset](https://docs.microsoft.com/en-us/bing/bing-video-search/overview). Use this
   * parameter only with the Video Search API.
   */
  offset?: number;
  /**
   ...
   * [Accept-Language](https://docs.microsoft.com/en-us/bing/bing-video-search/overview) header are
   ...
   * [textFormat](https://docs.microsoft.com/en-us/bing/bing-video-search/overview) query
   * parameter. For information about hit highlighting, see [Hit
   * Highlighting](https://docs.microsoft.com/en-us/bing/bing-video-search/overview).
   */
...
export interface VideosDetailsOptionalParams extends msRest.RequestOptionsBase {
   ...
   * An ID that uniquely identifies a video. The
   * [Video](https://docs.microsoft.com/en-us/bing/bing-video-search/overview) object's videoId
   * field contains the ID that you set this parameter to. You use this parameter to identify the
   * video to get insights of.
   */
  id?: string;
  /**
