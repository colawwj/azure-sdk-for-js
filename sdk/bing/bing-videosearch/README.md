...
```bash
npm install @azure/bing-videosearch
```
...
import { VideoSearchClient, VideoSearchModels, VideoSearchMappers } from "@azure/bing-videosearch";
...
<html lang="en">
  <head>
    <title>@azure/bing-videosearch sample</title>
    <script src="node_modules/@azure/ms-rest-js/dist/msRest.browser.js"></script>
    <script src="node_modules/@azure/ms-rest-browserauth/dist/msAuth.js"></script>
    <script src="node_modules/@azure/bing-videosearch/dist/bing-videosearch.js"></script>
    <script type="text/javascript">
      ...
      authManager.finalizeLogin().then((res) => {
        ...
        const client = new Azure.BingVideosearch.VideoSearchClient(res.creds, subscriptionId);
        const query = "testquery";
        const acceptLanguage = "testacceptLanguage";
        const userAgent = "testuserAgent";
        const clientId = "testclientId";
...
![Impressions](https://azure-sdk-impressions.azurewebsites.net/api/impressions/azure-sdk-for-js/sdk/bing/bing-videosearch/README.png)
