...
```bash
npm install @azure/bing-autosuggest
```
...
import { AutoSuggestClient, AutoSuggestModels, AutoSuggestMappers } from "@azure/bing-autosuggest";
...
<html lang="en">
  <head>
    <title>@azure/bing-autosuggest sample</title>
    <script src="node_modules/@azure/ms-rest-js/dist/msRest.browser.js"></script>
    <script src="node_modules/@azure/ms-rest-browserauth/dist/msAuth.js"></script>
    <script src="node_modules/@azure/bing-autosuggest/dist/bing-autosuggest.js"></script>
    <script type="text/javascript">
      ...
      authManager.finalizeLogin().then((res) => {
        ...
        const client = new Azure.BingAutosuggest.AutoSuggestClient(res.creds, subscriptionId);
        const query = "testquery";
        const acceptLanguage = "testacceptLanguage";
        const pragma = "testpragma";
        const userAgent = "testuserAgent";
...
![Impressions](https://azure-sdk-impressions.azurewebsites.net/api/impressions/azure-sdk-for-js/sdk/bing/bing-autosuggest/README.png)
