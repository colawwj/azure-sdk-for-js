...
export interface SuggestionsSuggestionGroup {
   ...
   * 'PersonalSearchDocuments', 'PersonalSearchTags', 'Custom'. Default value: 'Unknown'.
   */
  name: ScenarioType;
...
export interface AutoSuggestClientAutoSuggestOptionalParams extends msRest.RequestOptionsBase {
   ...
   * also specify the [cc](https://docs.microsoft.com/en-us/bing/bing-autosuggest/overview) query
   ...
   * [setLang](https://docs.microsoft.com/en-us/bing/bing-autosuggest/overview) query parameters. A
  ...
  market?: string;
  /**
   * Filter suggestions for adult content. The following are the possible filter values. Off:
   * Return suggestions with adult text, images, or videos. Moderate: Return suggestion with adult
   * text but not adult images or videos. Strict: Do not return news articles with adult text,
   * images, or videos. If the request comes from a market that Bing's adult policy requires that
