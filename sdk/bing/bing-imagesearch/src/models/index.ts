 ...
 * [insightsToken](https://docs.microsoft.com/en-us/bing/bing-image-search/overview) query
 * parameter. The modules query parameter affects the fields that Bing includes in the response. If
 * you set [modules](https://docs.microsoft.com/en-us/bing/bing-image-search/overview) to only
 * Caption, then this object includes only the imageCaption field.
 */
...
export interface ImagesSearchOptionalParams extends msRest.RequestOptionsBase {
   ...
   * [setLang](https://docs.microsoft.com/en-us/bing/bing-image-search/overview) query parameter
   * are mutually exclusive; do not specify both. If you set this header, you must also specify the
   * [cc](https://docs.microsoft.com/en-us/bing/bing-image-search/overview) query parameter. To
   ...
   * multiple languages. Otherwise, use the
   * [mkt](https://docs.microsoft.com/en-us/bing/bing-image-search/overview) and
   * [setLang](https://docs.microsoft.com/en-us/bing/bing-image-search/overview) query parameters.
   * A user interface string is a string that's used as a label in a user interface. There are few
   * user interface strings in the JSON response objects. Any links to Bing.com properties in the
   ...
   * values, see [Market Codes](https://docs.microsoft.com/en-us/bing/bing-image-search/overview).
   * If you set this parameter, you must also specify the
   * [Accept-Language](https://docs.microsoft.com/en-us/bing/bing-image-search/overview) header.
   * Bing uses the first supported language it finds from the languages list, and combine that
   * language with the country code that you specify to determine the market to return results for.
   * If the languages list does not include a supported language, Bing finds the closest language
   * and market that supports the request, or it may use an aggregated or default market for the
   * results instead of a specified one. You should use this query parameter and the
   ...
   * [mkt](https://docs.microsoft.com/en-us/bing/bing-image-search/overview) query parameter are
   ...
   * [Image](https://docs.microsoft.com/en-us/bing/bing-image-search/overview) object's imageId
   ...
   * Codes](https://docs.microsoft.com/en-us/bing/bing-image-search/overview), Bing uses a best fit
   * market code based on an internal mapping that is subject to change. This parameter and the
   * [cc](https://docs.microsoft.com/en-us/bing/bing-image-search/overview) query parameter are
   * mutually exclusive—do not specify both.
   */
  market?: string;
  /**
   ...
   * duplicates, see
   * [nextOffset](https://docs.microsoft.com/en-us/bing/bing-image-search/overview). Use this
   * parameter only with the Image API. Do not specify this parameter when calling the Trending
   * Images API or the Web Search API.
   */
  offset?: number;
  /**
   ...
   * [Accept-Language](https://docs.microsoft.com/en-us/bing/bing-image-search/overview) header are
   * mutually exclusive; do not specify both. A user interface string is a string that's used as a
   * label in a user interface. There are few user interface strings in the JSON response objects.
   * Also, any links to Bing.com properties in the response objects apply the specified language.
   */
  setLang?: string;
  /**
...
export interface ImagesDetailsOptionalParams extends msRest.RequestOptionsBase {
   ...
   * [modules](https://docs.microsoft.com/en-us/bing/bing-image-search/overview) query parameter to
   ...
   * see the [Content-Type](https://docs.microsoft.com/en-us/bing/bing-image-search/overview)
  ...
  imageUrl?: string;
  /**
   * An image token. The [Image](https://docs.microsoft.com/en-us/bing/bing-image-search/overview)
   * object's
   ...
   * you can get, see the
   * [modules](https://docs.microsoft.com/en-us/bing/bing-image-search/overview) query parameter.
   * Use this parameter only with the Insights API. Do not specify this parameter when calling the
