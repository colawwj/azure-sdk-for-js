...
```bash
npm install @azure/bing-entitysearch
```
...
import { EntitySearchClient, EntitySearchModels, EntitySearchMappers } from "@azure/bing-entitysearch";
...
<html lang="en">
  <head>
    <title>@azure/bing-entitysearch sample</title>
    <script src="node_modules/@azure/ms-rest-js/dist/msRest.browser.js"></script>
    <script src="node_modules/@azure/ms-rest-browserauth/dist/msAuth.js"></script>
    <script src="node_modules/@azure/bing-entitysearch/dist/bing-entitysearch.js"></script>
    <script type="text/javascript">
      ...
      authManager.finalizeLogin().then((res) => {
        ...
        const client = new Azure.BingEntitysearch.EntitySearchClient(res.creds, subscriptionId);
        const query = "testquery";
        const acceptLanguage = "testacceptLanguage";
        const pragma = "testpragma";
        const userAgent = "testuserAgent";
...
![Impressions](https://azure-sdk-impressions.azurewebsites.net/api/impressions/azure-sdk-for-js/sdk/bing/bing-entitysearch/README.png)
