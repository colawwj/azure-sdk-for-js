...
export interface ImageInfo {
   ...
   * [Image](https://docs.microsoft.com/en-us/bing/bing-visual-search/overview) object's
   * [imageInsightsToken](https://docs.microsoft.com/en-us/bing/bing-visual-search/overview) field
...
export interface ImagesVisualSearchOptionalParams extends msRest.RequestOptionsBase {
   ...
   * [setLang](https://docs.microsoft.com/en-us/bing/bing-visual-search/overview) query parameter
   * are mutually exclusive; do not specify both. If you set this header, you must also specify the
   * [cc](https://docs.microsoft.com/en-us/bing/bing-visual-search/overview) query parameter. To
   ...
   * [mkt](https://docs.microsoft.com/en-us/bing/bing-visual-search/overview) and
   * [setLang](https://docs.microsoft.com/en-us/bing/bing-visual-search/overview) query parameters.
   ...
   * multipart/form-data; boundary=<boundary string>). For more details, see [Content form
   ...
   * values, see [Market Codes](https://docs.microsoft.com/en-us/bing/bing-visual-search/overview).
   ...
   * Codes](https://docs.microsoft.com/en-us/bing/bing-visual-search/overview), Bing uses a best
