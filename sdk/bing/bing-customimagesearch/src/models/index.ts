...
export interface CustomInstanceImageSearchOptionalParams extends msRest.RequestOptionsBase {
   ...
   * [setLang](https://docs.microsoft.com/en-us/bing/bing-custom-search/overview) query parameter
   * are mutually exclusive; do not specify both. If you set this header, you must also specify the
   * [cc](https://docs.microsoft.com/en-us/bing/bing-custom-search/overview) query parameter. To
   ...
   * [mkt](https://docs.microsoft.com/en-us/bing/bing-custom-search/overview) and
   * [setLang](https://docs.microsoft.com/en-us/bing/bing-custom-search/overview) query parameters.
   ...
   * values, see [Market Codes](https://docs.microsoft.com/en-us/bing/bing-custom-search/overview).
   * If you set this parameter, you must also specify the
   * [Accept-Language](https://docs.microsoft.com/en-us/bing/bing-custom-search/overview) header.
   ...
   * [mkt](https://docs.microsoft.com/en-us/bing/bing-custom-search/overview) query parameter are
   ...
   * [Image](https://docs.microsoft.com/en-us/bing/bing-custom-search/overview) object's imageId
   ...
   * Codes](https://docs.microsoft.com/en-us/bing/bing-custom-search/overview), Bing uses a best
   * fit market code based on an internal mapping that is subject to change. This parameter and the
   * [cc](https://docs.microsoft.com/en-us/bing/bing-custom-search/overview) query parameter are
   * mutually exclusive—do not specify both.
   */
  market?: string;
  /**
   ...
   * duplicates, see
   * [nextOffset](https://docs.microsoft.com/en-us/bing/bing-custom-search/overview). Use this
   ...
   * [Accept-Language](https://docs.microsoft.com/en-us/bing/bing-custom-search/overview) header
   * are mutually exclusive; do not specify both. A user interface string is a string that's used
   * as a label in a user interface. There are few user interface strings in the JSON response
