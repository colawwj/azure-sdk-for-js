...
#### nodejs - client creation and get actionGroups as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  const actionGroupName = "testactionGroupName";
  client.actionGroups.get(resourceGroupName, actionGroupName).then((result) => {
...
#### browser - Authentication, client creation and get actionGroups as an example written in JavaScript.
