 ...
 * Optional Parameters.
 */
export interface PrivateEndpointConnectionApprovesOrRejectsOptionalParams extends msRest.RequestOptionsBase {
  /**
 ...
 */
export interface PrivateEndpointConnectionListResponse extends Array<PrivateEndpointConnectionResource> {
  /**
   * The link to the next page of results, if any remaining results exist.
   */
  nextLink?: string;
...
/**
 * Contains response data for the approvesOrRejects operation.
 */
export type PrivateEndpointConnectionApprovesOrRejectsResponse = PrivateEndpointConnectionResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
