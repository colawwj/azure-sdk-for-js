 ...
 */
export type MultiplePipelineTriggerUnion = MultiplePipelineTrigger | CustomEventsTrigger | BlobEventsTrigger | BlobTrigger | ScheduleTrigger;
...
export interface AzureMLExecutePipelineActivity {
  ...
  /**
   * Dictionary used for changing datapaths without retraining. Values will be passed in the
   * dataPathAssignments property of the published pipeline execution request. Type: object with
   * key value pairs (or Expression with resultType object).
   */
