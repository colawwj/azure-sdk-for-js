...
/**
 * Contains the possible cases for Credential.
 */
export type CredentialUnion = Credential | ServicePrincipalCredential;
 ...
 * Optional Parameters.
 */
export interface CredentialOperationsCreateOrUpdateOptionalParams extends msRest.RequestOptionsBase {
  /**
   * ETag of the credential entity. Should only be specified for update, for which it should match
   * existing entity or can be * for unconditional update.
   */
  ifMatch?: string;
}
 ...
 * Optional Parameters.
 */
export interface CredentialOperationsGetOptionalParams extends msRest.RequestOptionsBase {
  /**
   * ETag of the credential entity. Should only be specified for get. If the ETag matches the
   * existing entity tag, or if * was provided, then no content will be returned.
   */
  ifNoneMatch?: string;
}
 ...
 * @extends Array<CredentialResource>
 */
export interface CredentialListResponse extends Array<CredentialResource> {
  /**
   * The link to the next page of results, if any remaining results exist.
   */
  nextLink?: string;
...
export type CredentialOperationsListByFactoryResponse = CredentialListResponse & {
  ...
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: CredentialListResponse;
    };
};
