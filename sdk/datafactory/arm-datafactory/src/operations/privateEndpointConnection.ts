...
export class PrivateEndpointConnection {
   ...
   * @returns Promise<Models.PrivateEndpointConnectionApprovesOrRejectsResponse>
   */
  approvesOrRejects(resourceGroupName: string, factoryName: string, privateEndpointConnectionName: string, privateEndpointWrapper: Models.PrivateLinkConnectionApprovalRequestResource, options?: Models.PrivateEndpointConnectionApprovesOrRejectsOptionalParams): Promise<Models.PrivateEndpointConnectionApprovesOrRejectsResponse>;
  /**
   * @param resourceGroupName The resource group name.
   * @param factoryName The factory name.
   * @param privateEndpointConnectionName The private endpoint connection name.
   ...
   */
  approvesOrRejects(resourceGroupName: string, factoryName: string, privateEndpointConnectionName: string, privateEndpointWrapper: Models.PrivateLinkConnectionApprovalRequestResource, callback: msRest.ServiceCallback<Models.PrivateEndpointConnectionResource>): void;
  /**
   * @param resourceGroupName The resource group name.
   * @param factoryName The factory name.
   * @param privateEndpointConnectionName The private endpoint connection name.
   ...
   * @param callback The callback
   */
  approvesOrRejects(resourceGroupName: string, factoryName: string, privateEndpointConnectionName: string, privateEndpointWrapper: Models.PrivateLinkConnectionApprovalRequestResource, options: Models.PrivateEndpointConnectionApprovesOrRejectsOptionalParams, callback: msRest.ServiceCallback<Models.PrivateEndpointConnectionResource>): void;
  approvesOrRejects(resourceGroupName: string, factoryName: string, privateEndpointConnectionName: string, privateEndpointWrapper: Models.PrivateLinkConnectionApprovalRequestResource, options?: Models.PrivateEndpointConnectionApprovesOrRejectsOptionalParams | msRest.ServiceCallback<Models.PrivateEndpointConnectionResource>, callback?: msRest.ServiceCallback<Models.PrivateEndpointConnectionResource>): Promise<Models.PrivateEndpointConnectionApprovesOrRejectsResponse> {
    return this.client.sendOperationRequest(
      ...
      approvesOrRejectsOperationSpec,
      callback) as Promise<Models.PrivateEndpointConnectionApprovesOrRejectsResponse>;
  }
...
const approvesOrRejectsOperationSpec: msRest.OperationSpec = {
  httpMethod: "PUT",
