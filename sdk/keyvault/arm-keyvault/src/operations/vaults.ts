...
export class Vaults {
   ...
   */
  update(resourceGroupName: string, vaultName: string, parameters: Models.VaultPatchParameters, callback: msRest.ServiceCallback<any>): void;
  /**
   * @param resourceGroupName The name of the Resource Group to which the server belongs.
   * @param vaultName Name of the vault
   * @param parameters Parameters to patch the vault
   ...
   * @param callback The callback
   */
  update(resourceGroupName: string, vaultName: string, parameters: Models.VaultPatchParameters, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<any>): void;
  update(resourceGroupName: string, vaultName: string, parameters: Models.VaultPatchParameters, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<any>, callback?: msRest.ServiceCallback<any>): Promise<Models.VaultsUpdateResponse> {
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.VaultsDeleteMethodResponse>
   */
  deleteMethod(resourceGroupName: string, vaultName: string, options?: msRest.RequestOptionsBase): Promise<Models.VaultsDeleteMethodResponse>;
  /**
   * @param resourceGroupName The name of the Resource Group to which the vault belongs.
   * @param vaultName The name of the vault to delete
   * @param callback The callback
   */
  deleteMethod(resourceGroupName: string, vaultName: string, callback: msRest.ServiceCallback<Models.CloudError>): void;
  /**
   * @param resourceGroupName The name of the Resource Group to which the vault belongs.
   * @param vaultName The name of the vault to delete
   * @param options The optional parameters
   * @param callback The callback
   */
  deleteMethod(resourceGroupName: string, vaultName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.CloudError>): void;
  deleteMethod(resourceGroupName: string, vaultName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.CloudError>, callback?: msRest.ServiceCallback<Models.CloudError>): Promise<Models.VaultsDeleteMethodResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        vaultName,
      ...
      callback) as Promise<Models.VaultsDeleteMethodResponse>;
  }
   ...
   * @param callback The callback
   */
  get(resourceGroupName: string, vaultName: string, callback: msRest.ServiceCallback<any>): void;
  /**
   * @param resourceGroupName The name of the Resource Group to which the vault belongs.
   * @param vaultName The name of the vault.
   * @param options The optional parameters
   * @param callback The callback
   */
  get(resourceGroupName: string, vaultName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<any>): void;
  get(resourceGroupName: string, vaultName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<any>, callback?: msRest.ServiceCallback<any>): Promise<Models.VaultsGetResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        vaultName,
   ...
   * @param callback The callback
   */
  updateAccessPolicy(resourceGroupName: string, vaultName: string, operationKind: Models.AccessPolicyUpdateKind, parameters: Models.VaultAccessPolicyParameters, callback: msRest.ServiceCallback<any>): void;
  /**
   * @param resourceGroupName The name of the Resource Group to which the vault belongs.
   * @param vaultName Name of the vault
   * @param operationKind Name of the operation. Possible values include: 'add', 'replace', 'remove'
   ...
   * @param callback The callback
   */
  updateAccessPolicy(resourceGroupName: string, vaultName: string, operationKind: Models.AccessPolicyUpdateKind, parameters: Models.VaultAccessPolicyParameters, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<any>): void;
  updateAccessPolicy(resourceGroupName: string, vaultName: string, operationKind: Models.AccessPolicyUpdateKind, parameters: Models.VaultAccessPolicyParameters, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<any>, callback?: msRest.ServiceCallback<any>): Promise<Models.VaultsUpdateAccessPolicyResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        vaultName,
   ...
   * @param callback The callback
   */
  listDeleted(callback: msRest.ServiceCallback<any>): void;
  /**
   * @param options The optional parameters
   * @param callback The callback
   */
  listDeleted(options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<any>): void;
  listDeleted(options?: msRest.RequestOptionsBase | msRest.ServiceCallback<any>, callback?: msRest.ServiceCallback<any>): Promise<Models.VaultsListDeletedResponse> {
    return this.client.sendOperationRequest(
      {
        options
      },
   ...
   * @param callback The callback
   */
  getDeleted(vaultName: string, location: string, callback: msRest.ServiceCallback<any>): void;
  /**
   * @param vaultName The name of the vault.
   * @param location The location of the deleted vault.
   * @param options The optional parameters
   * @param callback The callback
   */
  getDeleted(vaultName: string, location: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<any>): void;
  getDeleted(vaultName: string, location: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<any>, callback?: msRest.ServiceCallback<any>): Promise<Models.VaultsGetDeletedResponse> {
    return this.client.sendOperationRequest(
      {
        vaultName,
        location,
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.VaultsPurgeDeletedResponse>
   */
  purgeDeleted(vaultName: string, location: string, options?: msRest.RequestOptionsBase): Promise<Models.VaultsPurgeDeletedResponse> {
    return this.beginPurgeDeleted(vaultName,location,options)
      .then(lroPoller => lroPoller.pollUntilFinished()) as Promise<Models.VaultsPurgeDeletedResponse>;
  }
   ...
   * @param callback The callback
   */
  listDeletedNext(nextPageLink: string, callback: msRest.ServiceCallback<any>): void;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param options The optional parameters
   * @param callback The callback
   */
  listDeletedNext(nextPageLink: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<any>): void;
  listDeletedNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<any>, callback?: msRest.ServiceCallback<any>): Promise<Models.VaultsListDeletedNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
