...
export interface VaultProperties {
   ...
   * by default. Once it's been set to true value, it can NOT be reverted to false. Default value:
   * true.
   */
...
export interface VaultPatchProperties {
  ...
  /**
   * Property to specify whether the 'soft delete' functionality is enabled for this key vault. If
   * omitted, assume false as default value when patching an existing vault. Once set to true,
   * cannot be reverted to false. Default value: false.
   */
  enableSoftDelete?: boolean;
  /**
   * softDelete data retention days. It accepts >=7 and <=90.
