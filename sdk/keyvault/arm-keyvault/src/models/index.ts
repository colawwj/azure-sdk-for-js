...
export interface VaultProperties {
   ...
   * omitted, assume true as default value. Once set to true, cannot be reverted to false.
   */
  enableSoftDelete?: boolean;
  /**
   * Property that controls how data actions are authorized. When true, this key vault uses Role
   * Based Access Control (RBAC) for authorization of data actions, and the access policies are
   * ignored (warning: this is a preview feature). When false, null or absent, this key vault uses
   * the specified access policies, and any policy stored on Azure Resource Manager is ignored.
   * Note that management actions are always authorized with RBAC. Default value: false.
   */
