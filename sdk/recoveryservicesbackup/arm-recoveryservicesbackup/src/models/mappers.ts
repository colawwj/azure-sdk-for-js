  ...
  type: {
    ...
    modelProperties: {
      ...
      targetDirectoryMapping: {
        serializedName: "targetDirectoryMapping",
        type: {
          name: "Dictionary",
          value: {
            type: {
...
export const MoveRPAcrossTiersRequestResource: msRest.CompositeMapper = {
  serializedName: "MoveRPAcrossTiersRequestResource",
  type: {
    name: "Composite",
    className: "MoveRPAcrossTiersRequestResource",
    modelProperties: {
