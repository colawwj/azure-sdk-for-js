...
export interface AzureWorkloadRestoreRequest {
   ...
   * include: 'Invalid', 'FileRecovery', 'WorkloadRecovery', 'SnapshotAttach',
...
export interface TargetRestoreInfo {
   ...
   */
  targetDirectoryMapping?: { [propertyName: string]: string };
  /**
...
/**
 * An interface representing MoveRPAcrossTiersRequestResource.
 */
export interface MoveRPAcrossTiersRequestResource extends Resource {
  /**
   * MoveRPAcrossTiersRequestResource properties
   */
  properties?: MoveRPAcrossTiersRequest;
}
 ...
 * Possible values include: 'Invalid', 'Full', 'Log', 'Differential', 'Incremental', 'SnapshotFull'
 * @readonly
 * @enum {string}
 */
export type RestorePointType = 'Invalid' | 'Full' | 'Log' | 'Differential' | 'Incremental' | 'SnapshotFull';
 ...
 * Possible values include: 'Invalid', 'FileRecovery', 'WorkloadRecovery', 'SnapshotAttach',
 * 'RecoveryUsingSnapshot'
 * @readonly
 * @enum {string}
 */
export type RecoveryMode = 'Invalid' | 'FileRecovery' | 'WorkloadRecovery' | 'SnapshotAttach' | 'RecoveryUsingSnapshot';
 ...
 * @enum {string}
 */
export type RestorePointQueryType = 'Invalid' | 'Full' | 'Log' | 'Differential' | 'FullAndDifferential' | 'All' | 'Incremental' | 'SnapshotFull';
