...
export class RecoveryPointsCrr {
   ...
   */
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase): Promise<Models.RecoveryPointsCrrListNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
  ...
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.RecoveryPointResourceList>, callback?: msRest.ServiceCallback<Models.RecoveryPointResourceList>): Promise<Models.RecoveryPointsCrrListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
