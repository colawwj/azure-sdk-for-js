...
class RecoveryServicesBackupClient extends RecoveryServicesBackupClientContext {
   ...
   */
  moveRecoveryPoint(vaultName: string, resourceGroupName: string, fabricName: string, containerName: string, protectedItemName: string, recoveryPointId: string, parameters: Models.MoveRPAcrossTiersRequestResource, options?: msRest.RequestOptionsBase): Promise<msRest.RestResponse> {
   ...
   */
  beginMoveRecoveryPoint(vaultName: string, resourceGroupName: string, fabricName: string, containerName: string, protectedItemName: string, recoveryPointId: string, parameters: Models.MoveRPAcrossTiersRequestResource, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
...
const beginMoveRecoveryPointOperationSpec: msRest.OperationSpec = {
  ...
  requestBody: {
    ...
    mapper: {
      ...Mappers.MoveRPAcrossTiersRequestResource,
      required: true
    }
  },
  responses: {
