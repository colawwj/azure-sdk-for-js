...
class RecoveryServicesBackupClient extends RecoveryServicesBackupClientContext {
   ...
   * @param callback The callback
   */
  bMSPrepareDataMove(vaultName: string, resourceGroupName: string, parameters: Models.PrepareDataMoveRequest, callback: msRest.ServiceCallback<void>): void;
  /**
   * @param vaultName The name of the recovery services vault.
   * @param resourceGroupName The name of the resource group where the recovery services vault is
   * present.
   ...
   * @param callback The callback
   */
  bMSPrepareDataMove(vaultName: string, resourceGroupName: string, parameters: Models.PrepareDataMoveRequest, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<void>): void;
  bMSPrepareDataMove(vaultName: string, resourceGroupName: string, parameters: Models.PrepareDataMoveRequest, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<void>, callback?: msRest.ServiceCallback<void>): Promise<msRest.RestResponse> {
    return this.sendOperationRequest(
      {
        vaultName,
        resourceGroupName,
...
const bMSPrepareDataMoveOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
