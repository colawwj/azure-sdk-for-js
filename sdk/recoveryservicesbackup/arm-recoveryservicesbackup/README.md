...
#### nodejs - client creation and list recoveryPoints as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  const protectedItemName = "testprotectedItemName";
  const filter = "testfilter";
  client.recoveryPoints.list(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, filter).then((result) => {
...
#### browser - Authentication, client creation and list recoveryPoints as an example written in JavaScript.
