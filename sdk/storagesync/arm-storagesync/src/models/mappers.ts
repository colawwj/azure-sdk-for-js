...
export const StorageSyncInnerErrorDetails: msRest.CompositeMapper = {
  serializedName: "StorageSyncInnerErrorDetails",
  type: {
    name: "Composite",
...
export const CloudEndpointLastChangeEnumerationStatus: msRest.CompositeMapper = {
  serializedName: "CloudEndpointLastChangeEnumerationStatus",
  type: {
    name: "Composite",
...
export const CloudEndpointChangeEnumerationActivity: msRest.CompositeMapper = {
  serializedName: "CloudEndpointChangeEnumerationActivity",
  type: {
    name: "Composite",
...
export const CloudEndpointChangeEnumerationStatus: msRest.CompositeMapper = {
  serializedName: "CloudEndpointChangeEnumerationStatus",
  type: {
    name: "Composite",
...
export const ServerEndpointBackgroundDataDownloadActivity: msRest.CompositeMapper = {
  serializedName: "ServerEndpointBackgroundDataDownloadActivity",
  type: {
    name: "Composite",
...
export const OperationResourceMetricSpecificationDimension: msRest.CompositeMapper = {
  serializedName: "OperationResourceMetricSpecificationDimension",
  type: {
    name: "Composite",
...
export const OperationResourceMetricSpecification: msRest.CompositeMapper = {
  serializedName: "OperationResourceMetricSpecification",
  type: {
    name: "Composite",
...
export const OperationResourceServiceSpecification: msRest.CompositeMapper = {
  serializedName: "OperationResourceServiceSpecification",
  type: {
    name: "Composite",
...
export const PrivateEndpointConnectionsCreateHeaders: msRest.CompositeMapper = {
  serializedName: "privateendpointconnections-create-headers",
  type: {
    name: "Composite",
