...
export interface CloudEndpointChangeEnumerationActivity {
  ...
  /**
   * Change enumeration operation state. Possible values include: 'InitialEnumerationInProgress',
   * 'EnumerationInProgress', 'Delayed'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
export interface ServerEndpointSyncSessionStatus {
  ...
  /**
   * Sync mode. Possible values include: 'Regular', 'NamespaceDownload', 'InitialUpload',
...
export interface RegisteredServer extends ProxyResource {
  ...
  agentVersion?: string;
  /**
   * Registered Server Agent Version Status. Possible values include: 'Ok', 'NearExpiry',
   * 'Expired', 'Blocked'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
export interface Workflow extends ProxyResource {
   ...
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly operation?: OperationDirection;
  /**
   * workflow steps
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 * Possible values include: 'InitialEnumerationInProgress', 'EnumerationInProgress', 'Delayed'
 * @readonly
 * @enum {string}
 */
export type CloudEndpointChangeEnumerationActivityState = 'InitialEnumerationInProgress' | 'EnumerationInProgress' | 'Delayed';

/**
 * Defines values for CloudEndpointChangeEnumerationTotalCountsState.
 * Possible values include: 'Calculating', 'Final'
 * @readonly
 * @enum {string}
 */
export type CloudEndpointChangeEnumerationTotalCountsState = 'Calculating' | 'Final';
 ...
 * Possible values include: 'Unavailable', 'Healthy', 'Error'
 * @readonly
 * @enum {string}
 */
 ...
 * Possible values include: 'Regular', 'NamespaceDownload', 'InitialUpload', 'SnapshotUpload',
 * 'InitialFullDownload'
 * @readonly
 * @enum {string}
 */
export type ServerEndpointSyncMode = 'Regular' | 'NamespaceDownload' | 'InitialUpload' | 'SnapshotUpload' | 'InitialFullDownload';
 ...
 * @enum {string}
 */
export type RegisteredServerAgentVersionStatus = 'Ok' | 'NearExpiry' | 'Expired' | 'Blocked';
