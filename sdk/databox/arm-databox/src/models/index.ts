...
export interface SkuInformation {
   ...
   * 'Feature', 'OfferType', 'NoSubscriptionInfo', 'CustomerUnregistered'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
export interface DataAccountDetails {
   ...
   * minimum of 12 and maximum of 64 characters. Password must have atleast one uppercase alphabet,
...
export interface DiskScheduleAvailabilityRequest {
  ...
  country?: string;
  /**
   * The expected size of the data, which needs to be transferred in this job, in tera bytes.
   */
  expectedDataSizeInTerabytes: number;
}
 ...
 * 'NoSubscriptionInfo', 'CustomerUnregistered'
 * @readonly
 * @enum {string}
 */
export type SkuDisabledReason = 'None' | 'Country' | 'Region' | 'Feature' | 'OfferType' | 'NoSubscriptionInfo' | 'CustomerUnregistered';
