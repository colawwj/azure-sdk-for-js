...
export interface LegacyUsageDetail {
  ...
  /**
   * Identifier that indicates how the meter is priced. (Values: On Demand, Reservation, Spot)
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
/**
 * Defines values for Scope9.
 * Possible values include: 'Single', 'Shared'
 * @readonly
 * @enum {string}
 */
export type Scope9 = 'Single' | 'Shared';

/**
 * Defines values for Scope11.
 * Possible values include: 'Single', 'Shared'
 * @readonly
 * @enum {string}
 */
export type Scope11 = 'Single' | 'Shared';
