...
#### nodejs - client creation and get tags as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  client.tags.get(scope).then((result) => {
...
#### browser - Authentication, client creation and get tags as an example written in JavaScript.
