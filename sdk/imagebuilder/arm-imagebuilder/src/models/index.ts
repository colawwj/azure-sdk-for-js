 ...
 */
export interface ImageTemplateKeyvaultProperties {
  /**
   * URI of Keyvault.
   */
  keyvaultUri?: string;
  /**
   * Name of Keyvault key.
   */
  keyName?: string;
  /**
   * Version of Keyvault key. Leave empty to always use the latest version of the key.
   */
  keyVersion?: string;
}
...
export interface ImageTemplateVmProfile {
   ...
   * string to use the default (Standard_D1_v2).
   */
  vmSize?: string;
  /**
...
export interface ImageTemplate extends Resource {
  ...
  /**
   * Customer Managed Key to be used for second level of encryption. Leave empty to disable second
   * level of encryption.
   */
  keyvaultProperties?: ImageTemplateKeyvaultProperties;
  /**
...
export interface ImageTemplatePowerShellCustomizer {
   ...
   * System user. Can only be true when the runElevated field above is set to true.
   */
  runAsSystem?: boolean;
  /**
