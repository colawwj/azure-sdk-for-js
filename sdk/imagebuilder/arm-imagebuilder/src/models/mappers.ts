...
export const ImageTemplateKeyvaultProperties: msRest.CompositeMapper = {
  serializedName: "ImageTemplateKeyvaultProperties",
  type: {
    name: "Composite",
    className: "ImageTemplateKeyvaultProperties",
    modelProperties: {
      keyvaultUri: {
