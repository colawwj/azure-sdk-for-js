...
export const BatchAccountIdentityUserAssignedIdentitiesValue: msRest.CompositeMapper = {
  serializedName: "BatchAccountIdentity_userAssignedIdentitiesValue",
  type: {
    name: "Composite",
    className: "BatchAccountIdentityUserAssignedIdentitiesValue",
    modelProperties: {
      principalId: {
        readOnly: true,
...
export const BatchPoolIdentityUserAssignedIdentitiesValue: msRest.CompositeMapper = {
  serializedName: "BatchPoolIdentity_userAssignedIdentitiesValue",
  type: {
    name: "Composite",
    className: "BatchPoolIdentityUserAssignedIdentitiesValue",
    modelProperties: {
      principalId: {
        readOnly: true,
        serializedName: "principalId",
