...
/**
 * An interface representing BatchAccountIdentityUserAssignedIdentitiesValue.
 */
export interface BatchAccountIdentityUserAssignedIdentitiesValue {
  /**
...
export interface BatchAccountIdentity {
   ...
   */
  userAssignedIdentities?: { [propertyName: string]: BatchAccountIdentityUserAssignedIdentitiesValue };
}
...
/**
 * An interface representing BatchPoolIdentityUserAssignedIdentitiesValue.
 */
export interface BatchPoolIdentityUserAssignedIdentitiesValue {
  /**
   * The principal id of user assigned identity.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
export interface BatchPoolIdentity {
   ...
   * '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
   */
  userAssignedIdentities?: { [propertyName: string]: BatchPoolIdentityUserAssignedIdentitiesValue };
}
