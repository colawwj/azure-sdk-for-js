 ...
 * Additional parameters for list operation.
 */
export interface ComputeNodeExtensionsListOptions {
  /**
   * An OData $select clause.
   */
  select?: string;
 ...
 * Additional parameters for listNext operation.
 */
export interface ComputeNodeExtensionsListNextOptions {
  /**
   * The caller-generated request identity, in the form of a GUID with no decoration such as curly
   * braces, e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0.
   */
 ...
 * Optional Parameters.
 */
export interface ComputeNodeExtensionsListOptionalParams extends msRest.RequestOptionsBase {
  /**
   * Additional parameters for the operation
   */
  computeNodeExtensionsListOptions?: ComputeNodeExtensionsListOptions;
}

/**
 * Optional Parameters.
 */
export interface ComputeNodeExtensionsListNextOptionalParams extends msRest.RequestOptionsBase {
  /**
   * Additional parameters for the operation
   */
  computeNodeExtensionsListNextOptions?: ComputeNodeExtensionsListNextOptions;
}
 ...
 * Contains response data for the list operation.
 */
export type ComputeNodeExtensionsListResponse = NodeVMExtensionList & ComputeNodeExtensionsListHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The parsed HTTP response headers.
       */
      parsedHeaders: ComputeNodeExtensionsListHeaders;
