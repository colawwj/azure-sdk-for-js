...
/**
 * Note: All times use the UTC time zone and are not impacted by daylight saving time.
...
/**
 * An interface representing NodePlacementConfiguration.
 */
...
export interface CloudJobSchedule {
  ...
  previousStateTransitionTime?: Date;
  /**
   * The schedule according to which Jobs will be created. Note: All times use the UTC time zone
...
export interface InstanceViewStatus {
  /**
   * The status code. **NOTE: This property will not be serialized. It can only be populated by the
   * server.**
   */
  readonly code?: string;
  /**
   * The localized label for the status. **NOTE: This property will not be serialized. It can only
  ...
  /**
   * The detailed status message. **NOTE: This property will not be serialized. It can only be
...
export interface VMExtensionInstanceView {
  /**
   * The name of the vm extension instance view. **NOTE: This property will not be serialized. It
...
export interface NodeVMExtension {
  /**
   * The provisioning state of the virtual machine extension. **NOTE: This property will not be
  ...
  /**
   * The virtual machine extension instance view. **NOTE: This property will not be serialized. It
   * can only be populated by the server.**
   */
  readonly instanceView?: VMExtensionInstanceView;
}
...
export interface CloudPool {
  ...
  mountConfiguration?: MountConfiguration[];
  /**
   * The identity type of the pool. Whether or not the pool uses a Managed Pool Identity.
   */
...
export interface JobSchedulePatchParameter {
   ...
   * existing schedule is left unchanged. Note: All times use the UTC time zone and are not
   * impacted by daylight saving time.
   */
  schedule?: Schedule;
  /**
...
export interface JobScheduleUpdateParameter {
   ...
   * immediately. Note: All times use the UTC time zone and are not impacted by daylight saving
   * time.
   */
  schedule: Schedule;
  /**
