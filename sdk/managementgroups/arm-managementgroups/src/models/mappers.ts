...
export const ManagementGroupPathElement: msRest.CompositeMapper = {
...
export const DescendantParentGroupInfo: msRest.CompositeMapper = {
...
export const DescendantInfo: msRest.CompositeMapper = {
...
export const ManagementGroupsCreateOrUpdateHeaders: msRest.CompositeMapper = {
  serializedName: "managementgroups-createorupdate-headers",
  type: {
    name: "Composite",
...
export const ManagementGroupsDeleteHeaders: msRest.CompositeMapper = {
  serializedName: "managementgroups-delete-headers",
  type: {
    name: "Composite",
...
export const DescendantListResult: msRest.CompositeMapper = {
