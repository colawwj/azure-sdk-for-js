...
export interface ManagedClusterPodIdentityProfile {
   ...
   */
  userAssignedPodIdentities?: ManagedClusterPodIdentity[];
  /**
   * User assigned pod identity exception settings.
   */
  userAssignedPodIdentityExceptions?: ManagedClusterPodIdentityException[];
}
 ...
 * Possible values include: 'rapid', 'stable', 'patch'
 * @readonly
 * @enum {string}
 */
export type UpgradeChannel = 'rapid' | 'stable' | 'patch';
