 ...
 * Contains response data for the list operation.
 */
export type MaintenanceConfigurationsListResponse = MaintenanceConfigurationListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listNext operation.
 */
export type MaintenanceConfigurationsListNextResponse = MaintenanceConfigurationListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
