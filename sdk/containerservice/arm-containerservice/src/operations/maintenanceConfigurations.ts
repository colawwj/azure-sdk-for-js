...
export class MaintenanceConfigurations {
   ...
   * @returns Promise<Models.MaintenanceConfigurationsListResponse>
   */
  list(resourceGroupName: string, resourceName: string, options?: msRest.RequestOptionsBase): Promise<Models.MaintenanceConfigurationsListResponse>;
  /**
   * @param resourceGroupName The name of the resource group.
   * @param resourceName The name of the managed cluster resource.
   * @param callback The callback
   */
  list(resourceGroupName: string, resourceName: string, callback: msRest.ServiceCallback<Models.MaintenanceConfigurationListResult>): void;
  /**
   * @param resourceGroupName The name of the resource group.
   * @param resourceName The name of the managed cluster resource.
   * @param options The optional parameters
   * @param callback The callback
   */
  list(resourceGroupName: string, resourceName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.MaintenanceConfigurationListResult>): void;
  list(resourceGroupName: string, resourceName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.MaintenanceConfigurationListResult>, callback?: msRest.ServiceCallback<Models.MaintenanceConfigurationListResult>): Promise<Models.MaintenanceConfigurationsListResponse> {
    return this.client.sendOperationRequest(
      ...
      listOperationSpec,
      callback) as Promise<Models.MaintenanceConfigurationsListResponse>;
  }
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.MaintenanceConfigurationsListNextResponse>
   */
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase): Promise<Models.MaintenanceConfigurationsListNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
  listNext(nextPageLink: string, callback: msRest.ServiceCallback<Models.MaintenanceConfigurationListResult>): void;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param options The optional parameters
   * @param callback The callback
   */
  listNext(nextPageLink: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.MaintenanceConfigurationListResult>): void;
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.MaintenanceConfigurationListResult>, callback?: msRest.ServiceCallback<Models.MaintenanceConfigurationListResult>): Promise<Models.MaintenanceConfigurationsListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
      ...
      callback) as Promise<Models.MaintenanceConfigurationsListNextResponse>;
  }
}
