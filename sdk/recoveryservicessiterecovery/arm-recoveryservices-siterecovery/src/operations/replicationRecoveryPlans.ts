...
export class ReplicationRecoveryPlans {
   ...
   * @param recoveryPlanName Recovery plan name.
   * @param [options] The optional parameters
   * @returns Promise<Models.ReplicationRecoveryPlansFailoverCancelResponse>
   */
  failoverCancel(recoveryPlanName: string, options?: msRest.RequestOptionsBase): Promise<Models.ReplicationRecoveryPlansFailoverCancelResponse> {
    return this.beginFailoverCancel(recoveryPlanName,options)
      .then(lroPoller => lroPoller.pollUntilFinished()) as Promise<Models.ReplicationRecoveryPlansFailoverCancelResponse>;
  }
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginFailoverCancel(recoveryPlanName: string, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        recoveryPlanName,
        options
