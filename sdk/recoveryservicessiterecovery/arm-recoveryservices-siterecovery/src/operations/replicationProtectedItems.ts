...
export class ReplicationProtectedItems {
   ...
   * @param replicatedProtectedItemName Replication protected item name.
   * @param [options] The optional parameters
   * @returns Promise<Models.ReplicationProtectedItemsFailoverCancelResponse>
   */
  failoverCancel(fabricName: string, protectionContainerName: string, replicatedProtectedItemName: string, options?: msRest.RequestOptionsBase): Promise<Models.ReplicationProtectedItemsFailoverCancelResponse> {
    return this.beginFailoverCancel(fabricName,protectionContainerName,replicatedProtectedItemName,options)
      .then(lroPoller => lroPoller.pollUntilFinished()) as Promise<Models.ReplicationProtectedItemsFailoverCancelResponse>;
  }
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginFailoverCancel(fabricName: string, protectionContainerName: string, replicatedProtectedItemName: string, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        fabricName,
        protectionContainerName,
      ...
      beginFailoverCancelOperationSpec,
      options);
  }
   ...
   */
  listNext(nextPageLink: string, options?: Models.ReplicationProtectedItemsListNextOptionalParams): Promise<Models.ReplicationProtectedItemsListNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listNext(nextPageLink: string, options: Models.ReplicationProtectedItemsListNextOptionalParams, callback: msRest.ServiceCallback<Models.ReplicationProtectedItemCollection>): void;
  listNext(nextPageLink: string, options?: Models.ReplicationProtectedItemsListNextOptionalParams | msRest.ServiceCallback<Models.ReplicationProtectedItemCollection>, callback?: msRest.ServiceCallback<Models.ReplicationProtectedItemCollection>): Promise<Models.ReplicationProtectedItemsListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
...
const beginFailoverCancelOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
