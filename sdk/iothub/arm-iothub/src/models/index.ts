...
export interface RegistryStatistics {
  /**
   * The total count of devices in the identity registry. This API is eventually consistent and may
   * not reflect correct device count immediately.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly totalDeviceCount?: number;
  /**
   * The count of enabled devices in the identity registry. This API is eventually consistent and
   * may not reflect correct device count immediately.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly enabledDeviceCount?: number;
  /**
   * The count of disabled devices in the identity registry. This API is eventually consistent and
   * may not reflect correct device count immediately.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
