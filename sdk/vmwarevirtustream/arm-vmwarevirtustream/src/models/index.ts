...
/**
 * An interface representing AzureVMwareSolutionbyVirtustreamAPIOptions.
 */
export interface AzureVMwareSolutionbyVirtustreamAPIOptions extends AzureServiceClientOptions {
  baseUri?: string;
}
