...
const packageName = "@azure/azure-media-edge-lva-client";
const packageVersion = "1.0.0";

export class DirectMethodsforLiveVideoAnalyticsonIoTEdgeContext extends msRestAzure.AzureServiceClient {
