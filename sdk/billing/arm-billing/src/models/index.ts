...
export interface Invoice extends Resource {
  ...
  /**
   * The invoice document number of the generated invoice.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 */
export interface EaInvoicesDownloadHeaders {
  /**
   * GET this URL to retrieve the status of the asynchronous operation.
   */
  location: string;
 ...
 * Defines headers for Download operation.
 */
export interface InvoicesDownloadHeaders {
  /**
   * GET this URL to retrieve the status of the asynchronous operation.
   */
  location: string;
 ...
 * Defines headers for Download operation.
 */
export interface BillingSubscriptionInvoicesDownloadHeaders {
  /**
   * GET this URL to retrieve the status of the asynchronous operation.
   */
  location: string;
 ...
 */
export type InvoicesDownloadResponse = DownloadUrl & InvoicesDownloadHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The parsed HTTP response headers.
       */
      parsedHeaders: InvoicesDownloadHeaders;
 ...
 * Contains response data for the get operation.
 */
export type BillingAccountInvoicesGetResponse = Invoice & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the download operation.
 */
export type EaInvoicesDownloadResponse = DownloadUrl & EaInvoicesDownloadHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The parsed HTTP response headers.
       */
      parsedHeaders: EaInvoicesDownloadHeaders;
 ...
 */
export type BillingSubscriptionInvoicesGetByIdResponse = Invoice & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the download operation.
 */
export type BillingSubscriptionInvoicesDownloadResponse = DownloadUrl & BillingSubscriptionInvoicesDownloadHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The parsed HTTP response headers.
       */
      parsedHeaders: BillingSubscriptionInvoicesDownloadHeaders;
