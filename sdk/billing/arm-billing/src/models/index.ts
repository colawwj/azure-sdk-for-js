 ...
 */
export interface PolicyPropertiesEnableMicrosoftAzurePlan {
  /**
...
export interface Policy extends Resource {
   ...
   * Enable Microsoft azure plan
   */
  enableMicrosoftAzurePlan?: PolicyPropertiesEnableMicrosoftAzurePlan;
}
 ...
 * Contains response data for the list operation.
 */
export type PartnerTransfersTransfersListResponse = TransferDetailsListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listNext operation.
 */
export type PartnerTransfersTransfersListNextResponse = TransferDetailsListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
