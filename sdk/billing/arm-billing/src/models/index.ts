 ...
 */
export interface TransfersChangeInvoiceSectionHeaders {
  /**
   * Location URI to poll for result.
   */
  location: string;
 ...
 */
export type TransfersChangeInvoiceSectionResponse = TransfersChangeInvoiceSectionHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The parsed HTTP response headers.
       */
      parsedHeaders: TransfersChangeInvoiceSectionHeaders;
    };
};
