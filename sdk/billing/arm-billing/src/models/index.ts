 ...
 */
export interface TransferDetails extends Resource {
  /**
 ...
 * Details of the transfer.
 */
export interface PartnerTransferDetails extends Resource {
  /**
   * The time at which the transfer request was created.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 * Details of the transfer.
 */
export interface RecipientTransferDetails extends Resource {
  /**
   * The time at which the transfer request was created.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
/**
 * Defines headers for ChangeInvoiceSection operation.
 */
export interface BillingSubscriptionsChangeInvoiceSectionHeaders {
  /**
   * Location URI to poll for result.
   */
  location: string;
 ...
 * @extends Array<PartnerTransferDetails>
 */
export interface PartnerTransferDetailsListResult extends Array<PartnerTransferDetails> {
  /**
   * The link (url) to the next page of results.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
/**
 * Contains response data for the changeInvoiceSection operation.
 */
export type BillingSubscriptionsChangeInvoiceSectionResponse = BillingSubscriptionsChangeInvoiceSectionHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The parsed HTTP response headers.
       */
      parsedHeaders: BillingSubscriptionsChangeInvoiceSectionHeaders;
    };
};
...
export type PartnerTransfersInitiateResponse = PartnerTransferDetails & {
  ...
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: PartnerTransferDetails;
    };
};
...
export type PartnerTransfersListResponse = PartnerTransferDetailsListResult & {
  ...
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: PartnerTransferDetailsListResult;
    };
};
