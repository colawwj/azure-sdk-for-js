...
/**
 * Error details of the dissociate payment instrument eligibility validation.
 */
export interface DissociatePaymentInstrumentErrorDetails {
  /**
   * Error code for the dissociate payment instrument eligibility validation. Possible values
   * include: 'AzureSubscriptions', 'RecurringCharges', 'ReservedInstances', 'OutstandingCharges',
   * 'PendingCharges'
   */
  code?: DissociatePaymentInstrumentEligibilityErrorCode;
  /**
   * Error message for the dissociate payment instrument eligibility validation.
   */
  message?: string;
}
 ...
 */
export interface DissociatePaymentInstrumentEligibilityResult {
  /**
  ...
  /**
   * The list of dissociate payment instrument eligibility errors.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly errorDetails?: DissociatePaymentInstrumentErrorDetails[];
}
 ...
 * Possible values include: 'AzureSubscriptions', 'RecurringCharges', 'ReservedInstances',
 * 'OutstandingCharges', 'PendingCharges'
 * @readonly
 * @enum {string}
 */
export type DissociatePaymentInstrumentEligibilityErrorCode = 'AzureSubscriptions' | 'RecurringCharges' | 'ReservedInstances' | 'OutstandingCharges' | 'PendingCharges';
...
/**
 * Contains response data for the validateDissociatePaymentInstrument operation.
 */
export type BillingProfileValidateDissociatePaymentInstrumentResponse = DissociatePaymentInstrumentEligibilityResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: DissociatePaymentInstrumentEligibilityResult;
    };
};
