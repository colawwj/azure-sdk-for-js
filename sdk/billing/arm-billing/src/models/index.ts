...
export interface BillingProfile extends Resource {
  ...
  /**
   * Specifies if the billing profile was created during transition of the billing account from
   * agreement type Microsoft Online Service Program to agreement type Microsoft Customer
   * Agreement.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
export interface BillingAccount extends Resource {
  ...
  readonly hasReadAccess?: boolean;
  /**
   * Specifies if the billing account has transitioned from agreement type Microsoft Online Service
