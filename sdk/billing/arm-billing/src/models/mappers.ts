...
export const PartnerTransferDetails: msRest.CompositeMapper = {
  serializedName: "PartnerTransferDetails",
  type: {
    name: "Composite",
...
export const BillingSubscriptionsChangeInvoiceSectionHeaders: msRest.CompositeMapper = {
  serializedName: "billingsubscriptions-changeinvoicesection-headers",
  type: {
    name: "Composite",
    className: "BillingSubscriptionsChangeInvoiceSectionHeaders",
    modelProperties: {
      location: {
        serializedName: "location",
        type: {
...
export const PartnerTransferDetailsListResult: msRest.CompositeMapper = {
  serializedName: "PartnerTransferDetailsListResult",
  type: {
    name: "Composite",
