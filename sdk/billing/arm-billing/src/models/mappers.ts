...
export const DissociatePaymentInstrumentErrorDetails: msRest.CompositeMapper = {
  serializedName: "DissociatePaymentInstrumentErrorDetails",
  type: {
    name: "Composite",
    className: "DissociatePaymentInstrumentErrorDetails",
    modelProperties: {
      code: {
        serializedName: "code",
        type: {
...
export const DissociatePaymentInstrumentEligibilityResult: msRest.CompositeMapper = {
  serializedName: "DissociatePaymentInstrumentEligibilityResult",
  type: {
    name: "Composite",
    className: "DissociatePaymentInstrumentEligibilityResult",
    modelProperties: {
      isEligible: {
        readOnly: true,
