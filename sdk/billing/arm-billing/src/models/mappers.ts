...
export const TransfersChangeInvoiceSectionHeaders: msRest.CompositeMapper = {
  serializedName: "transfers-changeinvoicesection-headers",
  type: {
    name: "Composite",
    className: "TransfersChangeInvoiceSectionHeaders",
    modelProperties: {
      location: {
        serializedName: "location",
        type: {
