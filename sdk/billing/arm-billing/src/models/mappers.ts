...
export const BudgetInformation: msRest.CompositeMapper = {
  serializedName: "BudgetInformation",
  type: {
    name: "Composite",
    className: "BudgetInformation",
    modelProperties: {
      amount: {
        serializedName: "amount",
        type: {
...
export const BillingProfile: msRest.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...
      budgetInformation: {
        serializedName: "properties.budgetInformation",
        type: {
          name: "Composite",
          className: "BudgetInformation"
        }
