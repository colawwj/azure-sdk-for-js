...
class BillingManagementClient extends BillingManagementClientContext {
  ...
  billingAccountInvoices: operations.BillingAccountInvoices;
  eaInvoices: operations.EaInvoices;
  priceSheet: operations.PriceSheet;
  billingSubscriptionInvoices: operations.BillingSubscriptionInvoices;
  ...
  constructor(credentials: msRest.ServiceClientCredentials, subscriptionId: string, options?: Models.BillingManagementClientOptions) {
    ...
    this.billingAccountInvoices = new operations.BillingAccountInvoices(this);
    this.eaInvoices = new operations.EaInvoices(this);
    this.priceSheet = new operations.PriceSheet(this);
    this.billingSubscriptionInvoices = new operations.BillingSubscriptionInvoices(this);
