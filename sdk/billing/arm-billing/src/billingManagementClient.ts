...
class BillingManagementClient extends BillingManagementClientContext {
  ...
  enrollmentDepartmentRoleAssignments: operations.EnrollmentDepartmentRoleAssignments;
  enrollmentAccountRoleAssignments: operations.EnrollmentAccountRoleAssignments;
  ...
  constructor(credentials: msRest.ServiceClientCredentials, subscriptionId: string, options?: Models.BillingManagementClientOptions) {
    ...
    this.enrollmentDepartmentRoleAssignments = new operations.EnrollmentDepartmentRoleAssignments(this);
    this.enrollmentAccountRoleAssignments = new operations.EnrollmentAccountRoleAssignments(this);
