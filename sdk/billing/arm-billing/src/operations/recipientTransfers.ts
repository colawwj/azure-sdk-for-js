...
export class RecipientTransfers {
  ...
  /**
   * @summary Validates if a subscription or a reservation can be transferred. Use this operation to
   * validate your subscriptions or reservation before using the accept transfer operation.
   * @param transferName The ID that uniquely identifies a transfer request.
   * @param [options] The optional parameters
  ...
  /**
   * @summary Gets a transfer request by ID. The caller must be the recipient of the transfer
   * request.
   * @param transferName The ID that uniquely identifies a transfer request.
   * @param [options] The optional parameters
