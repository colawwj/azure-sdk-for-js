...
export class BillingProfiles {
   ...
   */
  listByBillingAccountNext(nextPageLink: string, options?: Models.BillingProfilesListByBillingAccountNextOptionalParams): Promise<Models.BillingProfilesListByBillingAccountNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listByBillingAccountNext(nextPageLink: string, options: Models.BillingProfilesListByBillingAccountNextOptionalParams, callback: msRest.ServiceCallback<Models.BillingProfileListResult>): void;
  listByBillingAccountNext(nextPageLink: string, options?: Models.BillingProfilesListByBillingAccountNextOptionalParams | msRest.ServiceCallback<Models.BillingProfileListResult>, callback?: msRest.ServiceCallback<Models.BillingProfileListResult>): Promise<Models.BillingProfilesListByBillingAccountNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
