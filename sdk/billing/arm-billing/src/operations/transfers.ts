...
export class Transfers {
  ...
  /**
   * Moves a subscription's charges to a new invoice section. This operation is supported for billing
   * accounts with agreement type Microsoft Customer Agreement.
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param destinationInvoiceSectionId The destination invoice section id.
   * @param [options] The optional parameters
   * @returns Promise<Models.TransfersChangeInvoiceSectionResponse>
   */
  changeInvoiceSection(billingAccountName: string, destinationInvoiceSectionId: string, options?: msRest.RequestOptionsBase): Promise<Models.TransfersChangeInvoiceSectionResponse>;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param destinationInvoiceSectionId The destination invoice section id.
   * @param callback The callback
   */
  changeInvoiceSection(billingAccountName: string, destinationInvoiceSectionId: string, callback: msRest.ServiceCallback<void>): void;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param destinationInvoiceSectionId The destination invoice section id.
   * @param options The optional parameters
   * @param callback The callback
   */
  changeInvoiceSection(billingAccountName: string, destinationInvoiceSectionId: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<void>): void;
  changeInvoiceSection(billingAccountName: string, destinationInvoiceSectionId: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<void>, callback?: msRest.ServiceCallback<void>): Promise<Models.TransfersChangeInvoiceSectionResponse> {
    return this.client.sendOperationRequest(
      {
        billingAccountName,
      ...
      changeInvoiceSectionOperationSpec,
      callback) as Promise<Models.TransfersChangeInvoiceSectionResponse>;
  }
...
const changeInvoiceSectionOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
  path: "providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{subscriptionId}/changeInvoiceSection",
  urlParameters: [
    Parameters.billingAccountName,
  ...
  responses: {
    202: {
      headersMapper: Mappers.TransfersChangeInvoiceSectionHeaders
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
      headersMapper: Mappers.TransfersChangeInvoiceSectionHeaders
