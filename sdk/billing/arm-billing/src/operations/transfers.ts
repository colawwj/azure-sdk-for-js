...
export class Transfers {
   ...
   */
  initiate(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, transferName: string, parameters: Models.InitiateTransferRequest, options?: msRest.RequestOptionsBase): Promise<Models.TransfersInitiateResponse>;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param billingProfileName The ID that uniquely identifies a billing profile.
   * @param invoiceSectionName The ID that uniquely identifies an invoice section.
   ...
   * @param callback The callback
   */
  initiate(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, transferName: string, parameters: Models.InitiateTransferRequest, callback: msRest.ServiceCallback<Models.TransferDetails>): void;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param billingProfileName The ID that uniquely identifies a billing profile.
   * @param invoiceSectionName The ID that uniquely identifies an invoice section.
   ...
   * @param callback The callback
   */
  initiate(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, transferName: string, parameters: Models.InitiateTransferRequest, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.TransferDetails>): void;
  initiate(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, transferName: string, parameters: Models.InitiateTransferRequest, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.TransferDetails>, callback?: msRest.ServiceCallback<Models.TransferDetails>): Promise<Models.TransfersInitiateResponse> {
    return this.client.sendOperationRequest(
      {
        billingAccountName,
        billingProfileName,
