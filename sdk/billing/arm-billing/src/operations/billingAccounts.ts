...
export class BillingAccounts {
   ...
   * for billing accounts with agreement type Microsoft Customer Agreement. Currently address and
   * notification email address can be updated for billing accounts with agreement type Microsoft
   ...
   */
  listNext(nextPageLink: string, options?: Models.BillingAccountsListNextOptionalParams): Promise<Models.BillingAccountsListNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listNext(nextPageLink: string, options: Models.BillingAccountsListNextOptionalParams, callback: msRest.ServiceCallback<Models.BillingAccountListResult>): void;
  listNext(nextPageLink: string, options?: Models.BillingAccountsListNextOptionalParams | msRest.ServiceCallback<Models.BillingAccountListResult>, callback?: msRest.ServiceCallback<Models.BillingAccountListResult>): Promise<Models.BillingAccountsListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
