...
export class BillingPermissions {
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.BillingPermissionsListByDepartmentResponse>
   */
  listByDepartment(billingAccountName: string, departmentName: string, options?: msRest.RequestOptionsBase): Promise<Models.BillingPermissionsListByDepartmentResponse>;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param departmentName The ID that uniquely identifies a department.
   * @param callback The callback
   */
  listByDepartment(billingAccountName: string, departmentName: string, callback: msRest.ServiceCallback<Models.BillingPermissionsListResult>): void;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param departmentName The ID that uniquely identifies a department.
   * @param options The optional parameters
   * @param callback The callback
   */
  listByDepartment(billingAccountName: string, departmentName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.BillingPermissionsListResult>): void;
  listByDepartment(billingAccountName: string, departmentName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.BillingPermissionsListResult>, callback?: msRest.ServiceCallback<Models.BillingPermissionsListResult>): Promise<Models.BillingPermissionsListByDepartmentResponse> {
    return this.client.sendOperationRequest(
      {
        billingAccountName,
        departmentName,
      ...
      callback) as Promise<Models.BillingPermissionsListByDepartmentResponse>;
  }
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.BillingPermissionsListByEnrollmentAccountResponse>
   */
  listByEnrollmentAccount(billingAccountName: string, enrollmentAccountName: string, options?: msRest.RequestOptionsBase): Promise<Models.BillingPermissionsListByEnrollmentAccountResponse>;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param enrollmentAccountName The ID that uniquely identifies an enrollment account.
   * @param callback The callback
   */
  listByEnrollmentAccount(billingAccountName: string, enrollmentAccountName: string, callback: msRest.ServiceCallback<Models.BillingPermissionsListResult>): void;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param enrollmentAccountName The ID that uniquely identifies an enrollment account.
   * @param options The optional parameters
   * @param callback The callback
   */
  listByEnrollmentAccount(billingAccountName: string, enrollmentAccountName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.BillingPermissionsListResult>): void;
  listByEnrollmentAccount(billingAccountName: string, enrollmentAccountName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.BillingPermissionsListResult>, callback?: msRest.ServiceCallback<Models.BillingPermissionsListResult>): Promise<Models.BillingPermissionsListByEnrollmentAccountResponse> {
    return this.client.sendOperationRequest(
      {
        billingAccountName,
      ...
      callback) as Promise<Models.BillingPermissionsListByEnrollmentAccountResponse>;
  }
   ...
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param [options] The optional parameters
   * @returns Promise<Models.BillingPermissionsListByDepartmentNextResponse>
   */
  listByDepartmentNext(nextPageLink: string, options?: msRest.RequestOptionsBase): Promise<Models.BillingPermissionsListByDepartmentNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
  listByDepartmentNext(nextPageLink: string, callback: msRest.ServiceCallback<Models.BillingPermissionsListResult>): void;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param options The optional parameters
   * @param callback The callback
   */
  listByDepartmentNext(nextPageLink: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.BillingPermissionsListResult>): void;
  listByDepartmentNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.BillingPermissionsListResult>, callback?: msRest.ServiceCallback<Models.BillingPermissionsListResult>): Promise<Models.BillingPermissionsListByDepartmentNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
      ...
      callback) as Promise<Models.BillingPermissionsListByDepartmentNextResponse>;
  }
   ...
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param [options] The optional parameters
   * @returns Promise<Models.BillingPermissionsListByEnrollmentAccountNextResponse>
   */
  listByEnrollmentAccountNext(nextPageLink: string, options?: msRest.RequestOptionsBase): Promise<Models.BillingPermissionsListByEnrollmentAccountNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
  listByEnrollmentAccountNext(nextPageLink: string, callback: msRest.ServiceCallback<Models.BillingPermissionsListResult>): void;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param options The optional parameters
   * @param callback The callback
   */
  listByEnrollmentAccountNext(nextPageLink: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.BillingPermissionsListResult>): void;
  listByEnrollmentAccountNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.BillingPermissionsListResult>, callback?: msRest.ServiceCallback<Models.BillingPermissionsListResult>): Promise<Models.BillingPermissionsListByEnrollmentAccountNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
      ...
      callback) as Promise<Models.BillingPermissionsListByEnrollmentAccountNextResponse>;
  }
}
