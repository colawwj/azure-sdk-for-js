...
export class BillingSubscriptions {
   ...
   * @param destinationInvoiceSectionId The destination invoice section id.
   * @param [options] The optional parameters
   * @returns Promise<Models.BillingSubscriptionsChangeInvoiceSectionResponse>
   */
  changeInvoiceSection(billingAccountName: string, destinationInvoiceSectionId: string, options?: msRest.RequestOptionsBase): Promise<Models.BillingSubscriptionsChangeInvoiceSectionResponse> {
    return this.beginChangeInvoiceSection(billingAccountName,destinationInvoiceSectionId,options)
      .then(lroPoller => lroPoller.pollUntilFinished()) as Promise<Models.BillingSubscriptionsChangeInvoiceSectionResponse>;
  }
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginChangeInvoiceSection(billingAccountName: string, destinationInvoiceSectionId: string, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        billingAccountName,
        destinationInvoiceSectionId,
      ...
      beginChangeInvoiceSectionOperationSpec,
      options);
  }
...
const beginChangeInvoiceSectionOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
  ...
  responses: {
    202: {
      headersMapper: Mappers.BillingSubscriptionsChangeInvoiceSectionHeaders
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
      headersMapper: Mappers.BillingSubscriptionsChangeInvoiceSectionHeaders
