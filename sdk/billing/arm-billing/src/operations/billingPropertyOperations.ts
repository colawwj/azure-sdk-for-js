...
export class BillingPropertyOperations {
   ...
   * billing accounts with agreement type Microsoft Customer Agreement. Subscription address can be
   * updated for billing accounts with agreement type Microsoft Online Service Program. GST ID can be
   * updated for billing accounts with agreement type Microsoft Online Service Program only for
   * country India
   ...
   */
  update(parameters: Models.BillingProperty, options?: msRest.RequestOptionsBase): Promise<Models.BillingPropertyUpdateResponse>;
  /**
   * @param parameters Request parameters that are provided to the update billing property operation.
   * @param callback The callback
   */
  update(parameters: Models.BillingProperty, callback: msRest.ServiceCallback<Models.BillingProperty>): void;
  /**
   * @param parameters Request parameters that are provided to the update billing property operation.
   * @param options The optional parameters
   * @param callback The callback
   */
  update(parameters: Models.BillingProperty, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.BillingProperty>): void;
  update(parameters: Models.BillingProperty, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.BillingProperty>, callback?: msRest.ServiceCallback<Models.BillingProperty>): Promise<Models.BillingPropertyUpdateResponse> {
    return this.client.sendOperationRequest(
      {
        parameters,
        options
