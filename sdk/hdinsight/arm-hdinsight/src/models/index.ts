...
export interface BillingResponseListResult {
   ...
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly vmSizesWithEncryptionAtHost?: string[];
  /**
