 ...
 */
export interface UsageConfigurationThrottlePeriod {
  /**
   * The throttle period interval.
   */
  interval?: number;
  /**
   * The throttle frequency. Possible values include: 'NotSpecified', 'Second', 'Minute', 'Hour',
   * 'Day', 'Week', 'Month', 'Year'
   */
  frequency?: RecurrenceFrequency;
}
 ...
 */
export interface UsageConfigurationThrottle {
  /**
   ...
   * The usage configuration throttle period
   */
  period?: UsageConfigurationThrottlePeriod;
  /**
   * The trigger statuses to throttle
   */
  triggerStatuses?: WorkflowStatus[];
  /**
   * The action statuses to throttle
   */
  actionStatuses?: WorkflowStatus[];
}

/**
 * The integration account usage configuration.
 */
export interface IntegrationAccountUsageConfiguration extends Resource {
  /**
   ...
   */
  throttles?: { [propertyName: string]: UsageConfigurationThrottle };
  /**
   * The created time.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 * Optional Parameters.
 */
export interface IntegrationAccountUsageConfigurationsListOptionalParams extends msRest.RequestOptionsBase {
  /**
   * The number of items to be included in the result.
   */
  top?: number;
 ...
 * Optional Parameters.
 */
export interface IntegrationAccountUsageConfigurationsListNextOptionalParams extends msRest.RequestOptionsBase {
  /**
   * The number of items to be included in the result.
   */
  top?: number;
...
/**
 * @interface
 * The list of integration account usage configurations.
 * @extends Array<IntegrationAccountUsageConfiguration>
 */
export interface IntegrationAccountUsageConfigurationListResult extends Array<IntegrationAccountUsageConfiguration> {
  /**
   * The URL to get the next set of results.
   */
  nextLink?: string;
 ...
 * Contains response data for the list operation.
 */
export type IntegrationAccountUsageConfigurationsListResponse = IntegrationAccountUsageConfigurationListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: IntegrationAccountUsageConfigurationListResult;
    };
};
 ...
 * Contains response data for the get operation.
 */
export type IntegrationAccountUsageConfigurationsGetResponse = IntegrationAccountUsageConfiguration & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: IntegrationAccountUsageConfiguration;
    };
};
 ...
 * Contains response data for the createOrUpdate operation.
 */
export type IntegrationAccountUsageConfigurationsCreateOrUpdateResponse = IntegrationAccountUsageConfiguration & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listCallbackUrl operation.
 */
export type IntegrationAccountUsageConfigurationsListCallbackUrlResponse = WorkflowTriggerCallbackUrl & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listNext operation.
 */
export type IntegrationAccountUsageConfigurationsListNextResponse = IntegrationAccountUsageConfigurationListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
