...
class AzureMachineLearningWorkspacesDummyChange extends AzureMachineLearningWorkspacesDummyChangeContext {
  // Operation groups
  ...
  /**
   * Initializes a new instance of the AzureMachineLearningWorkspacesDummyChange class.
   * @param credentials Credentials needed for the client to connect to Azure.
   * @param subscriptionId Azure subscription identifier.
   * @param [options] The parameter options
   */
  constructor(credentials: msRest.ServiceClientCredentials, subscriptionId: string, options?: Models.AzureMachineLearningWorkspacesDummyChangeOptions) {
...
export {
  ...
  AzureMachineLearningWorkspacesDummyChangeContext,
  Models as AzureMachineLearningWorkspacesDummyChangeModels,
  Mappers as AzureMachineLearningWorkspacesDummyChangeMappers
};
