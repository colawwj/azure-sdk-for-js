...
/**
 * An interface representing AzureMachineLearningWorkspacesDummyChangeOptions.
 */
export interface AzureMachineLearningWorkspacesDummyChangeOptions extends AzureServiceClientOptions {
  baseUri?: string;
}
