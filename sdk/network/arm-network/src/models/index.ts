...
export interface AzureFirewallRCAction {
  /**
   * The type of action. Possible values include: 'Allow', 'Deny', 'Test'
   */
 ...
 * Possible values include: 'Allow', 'Deny', 'Test'
 * @readonly
 * @enum {string}
 */
export type AzureFirewallRCActionType = 'Allow' | 'Deny' | 'Test';
