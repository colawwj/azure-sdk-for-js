...
export interface ApplicationGatewayFrontendIPConfiguration extends SubResource {
  ...
  /**
   * Reference to the application gateway private link resource.
   */
...
export interface ApplicationGatewayPrivateLinkResource extends SubResource {
  /**
   * Reference to the subnet resource. A subnet is needed to support private link on application
   * gateway.
   */
  subnet?: SubResource;
  /**
   * Number of ip addresses to allocate from the private link resource subnet. Default is 1.
   */
  ipAddressesToAllocate?: number;
  /**
   * Group id is the identifier for private link resource. Use the identifier when creating or
   * updating private endpoint connection.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly groupId?: string;
  /**
   * The provisioning state of the application gateway private link resource. Possible values
   * include: 'Succeeded', 'Updating', 'Deleting', 'Failed'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly provisioningState?: ProvisioningState;
...
export interface ApplicationGateway extends Resource {
  ...
  /**
   * Private Link resources configured on application gateway.
   */
  privateLinkResources?: ApplicationGatewayPrivateLinkResource[];
  /**
 ...
 * Contains response data for the get operation.
 */
export type ApplicationGatewayPrivateLinkResourcesGetResponse = ApplicationGatewayPrivateLinkResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: ApplicationGatewayPrivateLinkResource;
    };
};
