...
export interface IpAllocation extends Resource {
   ...
   * IpAllocation tags.
   */
  ipAllocationTags?: { [propertyName: string]: string };
  /**
   * A unique read-only string that changes whenever the resource is updated.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 * Contains response data for the listAll operation.
 */
export type IpAllocationsListAllResponse = IpAllocationListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listAllNext operation.
 */
export type IpAllocationsListAllNextResponse = IpAllocationListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
