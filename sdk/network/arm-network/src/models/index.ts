...
export interface PublicIPAddress extends Resource {
  ...
  readonly provisioningState?: ProvisioningState;
  /**
   * The edge zone of the public IP address.
   */
  edgeZone?: string;
  /**
   * A unique read-only string that changes whenever the resource is updated.
 ...
 * Network Virtual Appliance Sku Properties.
 */
export interface SiteBreakOutCategoryPolicies {
  /**
   * Flag to control breakout of o365 allow category.
   */
  allow?: boolean;
 ...
 */
export interface SiteOffice365PolicyProperties {
  /**
   * Office 365 breakout categories.
   */
  breakOutCategories?: SiteBreakOutCategoryPolicies;
}

/**
 * Virtual Appliance Site resource.
 */
export interface NetworkVirtualApplianceSite extends Resource {
  /**
   * List of Network Virtual Appliances under a specific virtual appliance site.
   */
  networkVirtualApplianceIds?: string[];
  /**
   * Address Prefix.
   */
  addressPrefix?: string;
   ...
   * Office 365 Policy.
   */
  o365Policy?: SiteOffice365PolicyProperties;
  /**
   * The provisioning state of the resource. Possible values include: 'Succeeded', 'Updating',
   * 'Deleting', 'Failed'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
...
export interface VirtualNetworkGatewayConnection extends Resource {
  ...
  /**
   * The connection mode for this connection. Possible values include: 'Default', 'ResponderOnly',
   * 'InitiatorOnly'
   */
...
export interface VpnGatewayNatRule extends SubResource {
   ...
   */
  vpnGatewayNatRulePropertiesType?: VpnNatRuleType;
  /**
 ...
 * Optional Parameters.
 */
export interface WebCategoriesGetOptionalParams extends msRest.RequestOptionsBase {
  /**
 ...
 * Optional Parameters.
 */
export interface ConnectionMonitorsCreateOrUpdateOptionalParams extends msRest.RequestOptionsBase {
  /**
 ...
 * Optional Parameters.
 */
export interface ConnectionMonitorsBeginCreateOrUpdateOptionalParams extends msRest.RequestOptionsBase {
  /**
   * Value indicating whether connection monitor V1 should be migrated to V2 format.
   */
  migrate?: string;
 ...
 * @interface
 * Response for ListNetworkVirtualApplianceSites API service call.
 * @extends Array<NetworkVirtualApplianceSite>
 */
export interface VirtualApplianceSiteListResult extends Array<NetworkVirtualApplianceSite> {
  /**
   * URL to get the next set of results.
   */
  nextLink?: string;
...
/**
 * @interface
 * Result of the request to list all nat rules to a virtual wan vpn gateway. It contains a list of
 * Nat rules and a URL nextLink to get the next set of results.
 * @extends Array<VpnGatewayNatRule>
 */
export interface ListVpnGatewayNatRulesResult extends Array<VpnGatewayNatRule> {
  /**
   * URL to get the next set of operation list results if there are any.
   */
  nextLink?: string;
 ...
 * @enum {string}
 */
export type VirtualNetworkGatewayType = 'Vpn' | 'ExpressRoute' | 'LocalGateway';
 ...
 * Contains response data for the get operation.
 */
export type NetworkVirtualApplianceSitesGetResponse = NetworkVirtualApplianceSite & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: NetworkVirtualApplianceSite;
    };
};
 ...
 * Contains response data for the createOrUpdate operation.
 */
export type NetworkVirtualApplianceSitesCreateOrUpdateResponse = NetworkVirtualApplianceSite & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listByResourceGroup operation.
 */
export type NetworkVirtualApplianceSitesListByResourceGroupResponse = VirtualApplianceSiteListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: VirtualApplianceSiteListResult;
    };
};
 ...
 * Contains response data for the list operation.
 */
export type NetworkVirtualApplianceSitesListResponse = VirtualApplianceSiteListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export type NetworkVirtualApplianceSitesBeginCreateOrUpdateResponse = NetworkVirtualApplianceSite & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listByResourceGroupNext operation.
 */
export type NetworkVirtualApplianceSitesListByResourceGroupNextResponse = VirtualApplianceSiteListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listNext operation.
 */
export type NetworkVirtualApplianceSitesListNextResponse = VirtualApplianceSiteListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
...
export type NatRulesListByVpnGatewayResponse = ListVpnGatewayNatRulesResult & {
  ...
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: ListVpnGatewayNatRulesResult;
    };
};
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export type NatRulesBeginCreateOrUpdateResponse = VpnGatewayNatRule & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
