...
export interface IPConfigurationBgpPeeringAddress {
  ...
  /**
   * The list of default BgpPeeringAddresses which belongs to IpconfigurationId.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly defaultBgpIpAddresses?: string[];
  /**
   * The list of custom BgpPeeringAddresses which belongs to IpconfigurationId.
   */
  customBgpIpAddresses?: string[];
  /**
   * The list of tunnel public IpAddresses which belongs to IpconfigurationId.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
export interface VirtualNetworkGatewayBgpSettings {
  ...
  peerWeight?: number;
  /**
   * BgpPeeringAddresses for virtual network gateway.
   */
