...
export const VirtualNetworkGatewayBgpSettings: msRest.CompositeMapper = {
  serializedName: "VirtualNetworkGatewayBgpSettings",
  type: {
    name: "Composite",
    className: "VirtualNetworkGatewayBgpSettings",
    modelProperties: {
      asn: {
        serializedName: "asn",
        type: {
