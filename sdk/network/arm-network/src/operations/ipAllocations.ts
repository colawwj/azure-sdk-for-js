...
export class IpAllocations {
  ...
  /**
   * Creates or updates a IpAllocation in the specified resource group.
   * @param resourceGroupName The name of the resource group.
   * @param ipAllocationName The name of the IpAllocation.
  ...
  /**
   * Gets all IpAllocation in a subscription.
   * @param [options] The optional parameters
   * @returns Promise<Models.IpAllocationsListAllResponse>
   */
  listAll(options?: msRest.RequestOptionsBase): Promise<Models.IpAllocationsListAllResponse>;
  /**
   * @param callback The callback
   */
  listAll(callback: msRest.ServiceCallback<Models.IpAllocationListResult>): void;
  /**
   * @param options The optional parameters
   * @param callback The callback
   */
  listAll(options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.IpAllocationListResult>): void;
  listAll(options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.IpAllocationListResult>, callback?: msRest.ServiceCallback<Models.IpAllocationListResult>): Promise<Models.IpAllocationsListAllResponse> {
    return this.client.sendOperationRequest(
      {
        options
      },
      listAllOperationSpec,
      callback) as Promise<Models.IpAllocationsListAllResponse>;
  }

  /**
   * Gets all IpAllocation in a resource group.
   * @param resourceGroupName The name of the resource group.
   * @param [options] The optional parameters
   * @returns Promise<Models.IpAllocationsListResponse>
   */
  list(resourceGroupName: string, options?: msRest.RequestOptionsBase): Promise<Models.IpAllocationsListResponse>;
  /**
   * @param resourceGroupName The name of the resource group.
   * @param callback The callback
   */
  list(resourceGroupName: string, callback: msRest.ServiceCallback<Models.IpAllocationListResult>): void;
  /**
   * @param resourceGroupName The name of the resource group.
   * @param options The optional parameters
   * @param callback The callback
   */
  list(resourceGroupName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.IpAllocationListResult>): void;
  list(resourceGroupName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.IpAllocationListResult>, callback?: msRest.ServiceCallback<Models.IpAllocationListResult>): Promise<Models.IpAllocationsListResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        options
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.IpAllocationsListAllNextResponse>
   */
  listAllNext(nextPageLink: string, options?: msRest.RequestOptionsBase): Promise<Models.IpAllocationsListAllNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
  listAllNext(nextPageLink: string, callback: msRest.ServiceCallback<Models.IpAllocationListResult>): void;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param options The optional parameters
   * @param callback The callback
   */
  listAllNext(nextPageLink: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.IpAllocationListResult>): void;
  listAllNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.IpAllocationListResult>, callback?: msRest.ServiceCallback<Models.IpAllocationListResult>): Promise<Models.IpAllocationsListAllNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
      ...
      callback) as Promise<Models.IpAllocationsListAllNextResponse>;
  }
