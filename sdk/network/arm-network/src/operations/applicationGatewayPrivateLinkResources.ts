...
export class ApplicationGatewayPrivateLinkResources {
  ...
  /**
   * Gets the specified private link resource on an application gateway.
   * @param resourceGroupName The name of the resource group.
   * @param applicationGatewayName The name of the application gateway.
   * @param privateLinkResourceName The name of the private link resource.
   * @param [options] The optional parameters
   * @returns Promise<Models.ApplicationGatewayPrivateLinkResourcesGetResponse>
   */
  get(resourceGroupName: string, applicationGatewayName: string, privateLinkResourceName: string, options?: msRest.RequestOptionsBase): Promise<Models.ApplicationGatewayPrivateLinkResourcesGetResponse>;
  /**
   * @param resourceGroupName The name of the resource group.
   * @param applicationGatewayName The name of the application gateway.
   * @param privateLinkResourceName The name of the private link resource.
   ...
   */
  get(resourceGroupName: string, applicationGatewayName: string, privateLinkResourceName: string, callback: msRest.ServiceCallback<Models.ApplicationGatewayPrivateLinkResource>): void;
  /**
   * @param resourceGroupName The name of the resource group.
   * @param applicationGatewayName The name of the application gateway.
   * @param privateLinkResourceName The name of the private link resource.
   ...
   * @param callback The callback
   */
  get(resourceGroupName: string, applicationGatewayName: string, privateLinkResourceName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.ApplicationGatewayPrivateLinkResource>): void;
  get(resourceGroupName: string, applicationGatewayName: string, privateLinkResourceName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ApplicationGatewayPrivateLinkResource>, callback?: msRest.ServiceCallback<Models.ApplicationGatewayPrivateLinkResource>): Promise<Models.ApplicationGatewayPrivateLinkResourcesGetResponse> {
    return this.client.sendOperationRequest(
      ...
      getOperationSpec,
      callback) as Promise<Models.ApplicationGatewayPrivateLinkResourcesGetResponse>;
  }
...
const getOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
  path: "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/privateLinkResources/{privateLinkResourceName}",
  urlParameters: [
  ...
  responses: {
    200: {
      bodyMapper: Mappers.ApplicationGatewayPrivateLinkResource
    },
    default: {
