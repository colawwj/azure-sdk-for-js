 ...
 * Optional Parameters.
 */
export interface DpsCertificateAuthorityGetOptionalParams extends msRest.RequestOptionsBase {
  /**
   * ETag of the certificate.
   */
  ifMatch?: string;
 ...
 * Optional Parameters.
 */
export interface DpsCertificateAuthorityCreateOrUpdateOptionalParams extends msRest.RequestOptionsBase {
  /**
   * ETag of the certificate. This is required to update an existing certificate, and ignored while
   * creating a brand new certificate.
   */
 ...
 * Optional Parameters.
 */
export interface DpsCertificateAuthorityDeleteMethodOptionalParams extends msRest.RequestOptionsBase {
  /**
   * This is optional, and it is the Common Name of the certificate.
   */
  certificatename?: string;
 ...
 * Contains response data for the get operation.
 */
export type DpsCertificateAuthorityGetResponse = CertificateResponse & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the createOrUpdate operation.
 */
export type DpsCertificateAuthorityCreateOrUpdateResponse = CertificateResponse & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the list operation.
 */
export type DpsCertificateAuthorityListResponse = CertificateListDescription & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
