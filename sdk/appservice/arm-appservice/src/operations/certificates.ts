...
export class Certificates {
  ...
  createOrUpdate(resourceGroupName: string, name: string, certificateEnvelope: Models.Certificate, options?: msRest.RequestOptionsBase): Promise<Models.CertificatesCreateOrUpdateResponse> {
    return this.beginCreateOrUpdate(resourceGroupName,name,certificateEnvelope,options)
   ...
   */
  beginCreateOrUpdate(resourceGroupName: string, name: string, certificateEnvelope: Models.Certificate, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
