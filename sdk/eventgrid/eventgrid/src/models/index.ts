...
/**
 * Contains the possible cases for EventGridReceivedEvent.
 */
export type EventGridReceivedEventUnion = EventGridReceivedEvent | EventGridStorageBlobCreatedEventData;

/**
 * Properties of an event published to an Event Grid topic.
 */
export interface EventGridReceivedEvent {
  /**
   * Polymorphic Discriminator
   */
  eventType: "EventGridReceivedEvent";
  /**
 ...
 */
export interface EventGridStorageBlobCreatedEventData {
  /**
   * Polymorphic Discriminator
   */
   ...
   */
  dataVersion: string;
  data?: StorageBlobCreatedEventData;
}
