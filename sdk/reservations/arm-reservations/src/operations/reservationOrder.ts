...
export class ReservationOrder {
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.ReservationOrderChangeDirectoryResponse>
   */
  changeDirectory(reservationOrderId: string, body: Models.ChangeDirectoryRequest, options?: msRest.RequestOptionsBase): Promise<Models.ReservationOrderChangeDirectoryResponse>;
  /**
   * @param reservationOrderId Order Id of the reservation
   * @param body Information needed to change directory of reservation order
   * @param callback The callback
   */
  changeDirectory(reservationOrderId: string, body: Models.ChangeDirectoryRequest, callback: msRest.ServiceCallback<Models.ChangeDirectoryResponse>): void;
  /**
   * @param reservationOrderId Order Id of the reservation
   * @param body Information needed to change directory of reservation order
   * @param options The optional parameters
   * @param callback The callback
   */
  changeDirectory(reservationOrderId: string, body: Models.ChangeDirectoryRequest, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.ChangeDirectoryResponse>): void;
  changeDirectory(reservationOrderId: string, body: Models.ChangeDirectoryRequest, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ChangeDirectoryResponse>, callback?: msRest.ServiceCallback<Models.ChangeDirectoryResponse>): Promise<Models.ReservationOrderChangeDirectoryResponse> {
    return this.client.sendOperationRequest(
      {
        reservationOrderId,
        body,
      ...
      callback) as Promise<Models.ReservationOrderChangeDirectoryResponse>;
  }
...
const changeDirectoryOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
  ...
  requestBody: {
    parameterPath: "body",
    mapper: {
      ...Mappers.ChangeDirectoryRequest,
      required: true
    }
  },
  responses: {
