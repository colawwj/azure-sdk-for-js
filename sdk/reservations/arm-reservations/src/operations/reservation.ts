...
export class Reservation {
   ...
   */
  availableScopes(reservationOrderId: string, reservationId: string, body: Models.Scopes, options?: msRest.RequestOptionsBase): Promise<Models.ReservationAvailableScopesResponse> {
   ...
   */
  beginAvailableScopes(reservationOrderId: string, reservationId: string, body: Models.Scopes, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
