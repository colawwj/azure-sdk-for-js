...
/**
 * To be present only if ReturnRequestScope = Reservation and null otherwise
 */
 ...
 */
export interface ReturnRequestProperties {
  /**
   * Possible values include: 'Reservation'
   */
  scope?: Scope;
...
export interface ReturnRequest {
  /**
   * Fully qualified identifier of the ReservationOrder being returned
   */
  id?: string;
  properties?: ReturnRequestProperties;
}
...
export interface CalculateExchangeRequestProperties {
   ...
   */
  reservationsToExchange?: ReturnRequest[];
}
...
/**
 * An interface representing ChangeDirectoryRequest.
 */
...
export type ReservationOrderChangeDirectoryResponse = ChangeDirectoryResponse & {
  ...
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: ChangeDirectoryResponse;
    };
};
