...
export const AnalyticalStorageConfig: msRest.CompositeMapper = {
  serializedName: "AnalyticalStorageConfig",
  type: {
    name: "Composite",
    className: "AnalyticalStorageConfig",
    modelProperties: {
      schemaType: {
  ...
  type: {
    ...
    modelProperties: {
      ...
      analyticalStorageConfig: {
        serializedName: "properties.analyticalStorageConfig",
        type: {
          name: "Composite",
          className: "AnalyticalStorageConfig"
        }
