...
export class Profiles {
   ...
   * @param callback The callback
   */
  get(resourceGroupName: string, profileName: string, callback: msRest.ServiceCallback<Models.ProfileResult>): void;
  /**
   * @param resourceGroupName The name of the resource group containing the Traffic Manager profile.
   * @param profileName The name of the Traffic Manager profile.
   * @param options The optional parameters
   * @param callback The callback
   */
  get(resourceGroupName: string, profileName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.ProfileResult>): void;
  get(resourceGroupName: string, profileName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ProfileResult>, callback?: msRest.ServiceCallback<Models.ProfileResult>): Promise<Models.ProfilesGetResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        profileName,
   ...
   * @param callback The callback
   */
  createOrUpdate(resourceGroupName: string, profileName: string, parameters: Models.Profile, callback: msRest.ServiceCallback<Models.ProfileResult>): void;
  /**
   * @param resourceGroupName The name of the resource group containing the Traffic Manager profile.
   * @param profileName The name of the Traffic Manager profile.
   * @param parameters The Traffic Manager profile parameters supplied to the CreateOrUpdate
   ...
   * @param callback The callback
   */
  createOrUpdate(resourceGroupName: string, profileName: string, parameters: Models.Profile, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.ProfileResult>): void;
  createOrUpdate(resourceGroupName: string, profileName: string, parameters: Models.Profile, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ProfileResult>, callback?: msRest.ServiceCallback<Models.ProfileResult>): Promise<Models.ProfilesCreateOrUpdateResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        profileName,
   ...
   * @param callback The callback
   */
  update(resourceGroupName: string, profileName: string, parameters: Models.Profile, callback: msRest.ServiceCallback<Models.ProfileResult>): void;
  /**
   * @param resourceGroupName The name of the resource group containing the Traffic Manager profile.
   * @param profileName The name of the Traffic Manager profile.
   * @param parameters The Traffic Manager profile parameters supplied to the Update operation.
   ...
   * @param callback The callback
   */
  update(resourceGroupName: string, profileName: string, parameters: Models.Profile, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.ProfileResult>): void;
  update(resourceGroupName: string, profileName: string, parameters: Models.Profile, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ProfileResult>, callback?: msRest.ServiceCallback<Models.ProfileResult>): Promise<Models.ProfilesUpdateResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        profileName,
...
const getOperationSpec: msRest.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.ProfileResult
    },
    default: {
      bodyMapper: Mappers.CloudError
    }
