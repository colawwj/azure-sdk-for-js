...
export class Endpoints {
   ...
   */
  update(resourceGroupName: string, profileName: string, endpointType: string, endpointName: string, parameters: Models.Endpoint, callback: msRest.ServiceCallback<Models.EndpointResult>): void;
  /**
   * @param resourceGroupName The name of the resource group containing the Traffic Manager endpoint
   * to be updated.
   * @param profileName The name of the Traffic Manager profile.
   ...
   * @param callback The callback
   */
  update(resourceGroupName: string, profileName: string, endpointType: string, endpointName: string, parameters: Models.Endpoint, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.EndpointResult>): void;
  update(resourceGroupName: string, profileName: string, endpointType: string, endpointName: string, parameters: Models.Endpoint, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.EndpointResult>, callback?: msRest.ServiceCallback<Models.EndpointResult>): Promise<Models.EndpointsUpdateResponse> {
   ...
   * @param callback The callback
   */
  get(resourceGroupName: string, profileName: string, endpointType: string, endpointName: string, callback: msRest.ServiceCallback<Models.EndpointResult>): void;
  /**
   * @param resourceGroupName The name of the resource group containing the Traffic Manager endpoint.
   * @param profileName The name of the Traffic Manager profile.
   * @param endpointType The type of the Traffic Manager endpoint.
   ...
   * @param callback The callback
   */
  get(resourceGroupName: string, profileName: string, endpointType: string, endpointName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.EndpointResult>): void;
  get(resourceGroupName: string, profileName: string, endpointType: string, endpointName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.EndpointResult>, callback?: msRest.ServiceCallback<Models.EndpointResult>): Promise<Models.EndpointsGetResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        profileName,
   ...
   * @param callback The callback
   */
  createOrUpdate(resourceGroupName: string, profileName: string, endpointType: string, endpointName: string, parameters: Models.Endpoint, callback: msRest.ServiceCallback<Models.EndpointResult>): void;
  /**
   * @param resourceGroupName The name of the resource group containing the Traffic Manager endpoint
   * to be created or updated.
   * @param profileName The name of the Traffic Manager profile.
   ...
   * @param callback The callback
   */
  createOrUpdate(resourceGroupName: string, profileName: string, endpointType: string, endpointName: string, parameters: Models.Endpoint, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.EndpointResult>): void;
  createOrUpdate(resourceGroupName: string, profileName: string, endpointType: string, endpointName: string, parameters: Models.Endpoint, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.EndpointResult>, callback?: msRest.ServiceCallback<Models.EndpointResult>): Promise<Models.EndpointsCreateOrUpdateResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        profileName,
...
const updateOperationSpec: msRest.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.EndpointResult
    },
    default: {
