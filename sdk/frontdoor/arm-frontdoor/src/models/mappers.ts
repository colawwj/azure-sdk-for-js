...
export const SecurityPolicyLink: msRest.CompositeMapper = {
  serializedName: "SecurityPolicyLink",
  type: {
    name: "Composite",
...
export const ManagedRuleSetDefinition: msRest.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...
      ruleSetVersionState: {
        serializedName: "properties.ruleSetVersionState",
        type: {
          name: "String"
        }
      },
      ruleSetDefaultAction: {
        readOnly: true,
        serializedName: "properties.ruleSetDefaultAction",
        type: {
          name: "String"
        }
      },
      ruleSetFeatures: {
        readOnly: true,
        serializedName: "properties.ruleSetFeatures",
        type: {
          name: "Sequence",
          element: {
            type: {
