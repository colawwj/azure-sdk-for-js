...
export interface PolicySettings {
  ...
  /**
   * Describes if policy managed rules will inspect the request body content. Possible values
...
export interface ManagedRuleSet {
  ...
  /**
   * Possible values include: 'Block', 'Log', 'Redirect'
   */
...
export interface WebApplicationFirewallPolicy extends Resource {
  ...
  /**
   * Describes CDN Security Policies associated with this Web Application Firewall policy.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  ...
  etag?: string;
  /**
   * The pricing tier of web application firewall policy. Defaults to Enabled if not specified.
   */
  sku?: Sku;
}
...
export interface ManagedRuleDefinition {
   ...
   * include: 'Block', 'Log', 'Redirect', 'SetScore'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly defaultAction?: ManagedRuleActionType;
  /**
...
export interface ManagedRuleSetDefinition extends Resource {
  ...
  /**
   * State of the rule set version. Possible values include: 'Recommended', 'Supported',
   * 'Deprecated'
   */
  ruleSetVersionState?: RuleSetVersionStateType;
  /**
   * Possible values include: 'Block', 'Log', 'Redirect'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly ruleSetDefaultAction?: ManagedRuleSetActionType;
  /**
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly ruleSetFeatures?: RuleSetFeatureType[];
  /**
 ...
 * 'RequestBodyPostArgNames', 'RequestBodyJsonArgNames'
 * @readonly
 * @enum {string}
 */
export type ManagedRuleExclusionMatchVariable = 'RequestHeaderNames' | 'RequestCookieNames' | 'QueryStringArgNames' | 'RequestBodyPostArgNames' | 'RequestBodyJsonArgNames';
...
/**
 * Defines values for ManagedRuleActionType.
 * Possible values include: 'Block', 'Log', 'Redirect', 'SetScore'
 * @readonly
 * @enum {string}
 */
export type ManagedRuleActionType = 'Block' | 'Log' | 'Redirect' | 'SetScore';
...
/**
 * Defines values for RuleSetVersionStateType.
 * Possible values include: 'Recommended', 'Supported', 'Deprecated'
 * @readonly
 * @enum {string}
 */
export type RuleSetVersionStateType = 'Recommended' | 'Supported' | 'Deprecated';

/**
 * Defines values for RuleSetFeatureType.
 * Possible values include: 'AnomalyScoreMode'
 * @readonly
 * @enum {string}
 */
export type RuleSetFeatureType = 'AnomalyScoreMode';
