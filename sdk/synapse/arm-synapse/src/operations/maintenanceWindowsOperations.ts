...
export class MaintenanceWindowsOperations {
   ...
   */
  get(resourceGroupName: string, workspaceName: string, sqlPoolName: string, maintenanceWindowName: string, options?: msRest.RequestOptionsBase): Promise<Models.MaintenanceWindowsGetResponse>;
  /**
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   * @param workspaceName The name of the workspace
   * @param sqlPoolName SQL pool name
  ...
  get(resourceGroupName: string, workspaceName: string, sqlPoolName: string, maintenanceWindowName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.MaintenanceWindows>, callback?: msRest.ServiceCallback<Models.MaintenanceWindows>): Promise<Models.MaintenanceWindowsGetResponse> {
