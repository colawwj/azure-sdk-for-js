...
export interface MaintenanceWindowOptions extends ProxyResource {
  /**
   * Whether maintenance windows are enabled for the Sql pool.
   */
  isEnabled?: boolean;
  /**
  ...
  /**
   * Minimum number of maintenance windows cycles to be set on the Sql pool.
   */
  minCycles?: number;
  /**
 ...
 */
export interface BabylonConfiguration {
  /**
   * Babylon Resource ID
   */
