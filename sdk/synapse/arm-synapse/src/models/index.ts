 ...
 * Contains response data for the createOrUpdate operation.
 */
export type WorkspaceManagedqlServerBlobAuditingPoliciesCreateOrUpdateResponse = ServerBlobAuditingPolicy & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export type WorkspaceManagedqlServerBlobAuditingPoliciesBeginCreateOrUpdateResponse = ServerBlobAuditingPolicy & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
