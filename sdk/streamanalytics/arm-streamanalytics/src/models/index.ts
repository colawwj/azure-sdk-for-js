 ...
 */
export type FunctionBindingUnion = FunctionBinding | AzureMachineLearningStudioFunctionBinding | AzureMachineLearningServiceFunctionBinding | JavaScriptFunctionBinding | CSharpFunctionBinding;
...
/**
 * An interface representing AggregateFunctionProperties.
 */
 ...
 */
export type StreamInputDataSourceUnion = StreamInputDataSource | BlobStreamInputDataSource | EventHubStreamInputDataSource | IoTHubStreamInputDataSource;
 ...
 */
export type OutputDataSourceUnion = OutputDataSource | BlobOutputDataSource | AzureTableOutputDataSource | EventHubOutputDataSource | AzureSqlDatabaseOutputDataSource | AzureSynapseOutputDataSource | DocumentDbOutputDataSource | AzureFunctionOutputDataSource | ServiceBusQueueOutputDataSource | ServiceBusTopicOutputDataSource | PowerBIOutputDataSource | AzureDataLakeStoreOutputDataSource;
...
export interface StreamingJob extends TrackedResource {
   ...
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly contentStoragePolicy?: ContentStoragePolicy;
  /**
   * Describes how identity is verified.
   */
  identity?: Identity;
  ...
  externals?: External;
  /**
   * The resource id of cluster which streaming jobs will run on.
   */
  cluster?: string;
}
