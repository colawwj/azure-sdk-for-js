...
export interface ConfigurationStoresListKeysOptionalParams extends msRest.RequestOptionsBase {
  ...
  skipToken?: string;
  /**
   * The filter to apply on the access keys. For example, you can use "$filter=readOnly eq true" to
   * retrieve only read-only access keys. Properties that support filtering include 'name' and
   * 'readOnly'.
   */
  filter?: string;
}
