 ...
 */
export interface SubscriberIdentityInfo {
  /**
   ...
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly clientAuthorizationSource?: string;
}

/**
 * The event grid filter resource along with all resource properties.
 */
export interface EventGridFilter extends BaseResource {
  /**
   * The resource ID.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  ...
  readonly type?: string;
  /**
   * The provisioning state of the event grid filter. Possible values include: 'Creating',
   * 'Updating', 'Deleting', 'Succeeded', 'Failed', 'Canceled'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly provisioningState?: ProvisioningState;
   ...
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly subscriberIdentityInfo?: SubscriberIdentityInfo;
}
 ...
 * Optional Parameters.
 */
export interface EventGridFiltersListByConfigurationStoreOptionalParams extends msRest.RequestOptionsBase {
  /**
   * A skip token is used to continue retrieving items after an operation returns a partial result.
   * If a previous response contains a nextLink element, the value of the nextLink element will
   * include a skipToken parameter that specifies a starting point to use for subsequent calls.
 ...
 * Optional Parameters.
 */
export interface EventGridFiltersListByConfigurationStoreNextOptionalParams extends msRest.RequestOptionsBase {
  /**
   * A skip token is used to continue retrieving items after an operation returns a partial result.
   * If a previous response contains a nextLink element, the value of the nextLink element will
   * include a skipToken parameter that specifies a starting point to use for subsequent calls.
 ...
 * @extends Array<EventGridFilter>
 */
export interface EventGridFilterListResult extends Array<EventGridFilter> {
  /**
   * The URI that can be used to request the next set of paged results.
   */
  nextLink?: string;
 ...
 * Contains response data for the listByConfigurationStore operation.
 */
export type EventGridFiltersListByConfigurationStoreResponse = EventGridFilterListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: EventGridFilterListResult;
    };
};
 ...
 * Contains response data for the get operation.
 */
export type EventGridFiltersGetResponse = EventGridFilter & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listByConfigurationStoreNext operation.
 */
export type EventGridFiltersListByConfigurationStoreNextResponse = EventGridFilterListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
