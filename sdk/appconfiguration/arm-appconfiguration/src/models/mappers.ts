...
export const EventFilter: msRest.CompositeMapper = {
...
export const SubscriberIdentityInfo: msRest.CompositeMapper = {
  serializedName: "SubscriberIdentityInfo",
  type: {
    name: "Composite",
    className: "SubscriberIdentityInfo",
    modelProperties: {
      clientPrincipalId: {
        readOnly: true,
        serializedName: "clientPrincipalId",
        type: {
          name: "String"
        }
      },
      ...
      clientAuthorizationSource: {
        readOnly: true,
        serializedName: "clientAuthorizationSource",
        type: {
          name: "String"
        }
      }
...
export const EventGridFilter: msRest.CompositeMapper = {
  serializedName: "EventGridFilter",
  type: {
    name: "Composite",
    className: "EventGridFilter",
    modelProperties: {
      id: {
        readOnly: true,
        serializedName: "id",
      ...
      subscriberIdentityInfo: {
        readOnly: true,
        serializedName: "properties.subscriberIdentityInfo",
        type: {
          name: "Composite",
          className: "SubscriberIdentityInfo"
        }
...
export const EventGridFilterListResult: msRest.CompositeMapper = {
  serializedName: "EventGridFilterListResult",
  type: {
    name: "Composite",
    className: "EventGridFilterListResult",
    modelProperties: {
      value: {
        serializedName: "",
        type: {
