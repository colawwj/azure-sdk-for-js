...
export interface ResponseBasedOriginErrorDetectionParameters {
  ...
  /**
   * The list of Http status code ranges that are considered as server errors for origin to be
   * deeemed unhealthy.
   */
...
export interface Endpoint extends TrackedResource {
  ...
  /**
   * The host header value sent to the origin with each request. This proerty at Endpoint is only
