...
export const VNetProperties: msRest.CompositeMapper = {
  serializedName: "VNetProperties",
  type: {
    name: "Composite",
    className: "VNetProperties",
    modelProperties: {
      vNetResourceId: {
        readOnly: true,
      ...
      systemSubnetName: {
        readOnly: true,
        serializedName: "systemSubnetName",
        type: {
          name: "String"
        }
      },
...
export const EncryptionKeyProperties: msRest.CompositeMapper = {
  serializedName: "EncryptionKeyProperties",
  type: {
    name: "Composite",
    className: "EncryptionKeyProperties",
    modelProperties: {
      keyVaultUri: {
...
export const AutoScaleSku: msRest.CompositeMapper = {
  serializedName: "AutoScaleSku",
  type: {
    name: "Composite",
    className: "AutoScaleSku",
    modelProperties: {
      resourceType: {
        required: true,
        serializedName: "resourceType",
...
export const AutoScaleSkuCollection: msRest.CompositeMapper = {
  serializedName: "AutoScaleSkuCollection",
  type: {
    name: "Composite",
    className: "AutoScaleSkuCollection",
    modelProperties: {
      value: {
