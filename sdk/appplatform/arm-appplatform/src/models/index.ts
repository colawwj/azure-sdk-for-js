...
export interface VNetProperties {
   ...
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly systemSubnetName?: string;
  /**
   * Name of the user cluster subnet
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly userSubnetName?: string;
  /**
...
/**
 * An interface representing EncryptionKeyProperties.
 */
...
export interface EncryptionProperties {
  /**
   * Possible values include: 'None', 'Microsoft.AppPlatform', 'Microsoft.KeyVault'
   */
  keySource?: EncryptionKeySourceType;
  keyVaultProperties?: EncryptionKeyProperties;
}
...
export interface AppResource extends ProxyResource {
   ...
   * ARM use this property to route the MSI request to regional MSI RP
   */
  location?: string;
}
...
/**
 * An interface representing AutoScaleSku.
 */
export interface AutoScaleSku {
  /**
...
/**
 * An interface representing AutoScaleSkuCollection.
 */
export interface AutoScaleSkuCollection {
  /**
 ...
 * @enum {string}
 */
export type EncryptionKeySourceType = 'None' | 'Microsoft.AppPlatform' | 'Microsoft.KeyVault';
...
/**
 * Contains response data for the getSkus operation.
 */
export type DeploymentsGetSkusResponse = AutoScaleSkuCollection & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: AutoScaleSkuCollection;
    };
};
