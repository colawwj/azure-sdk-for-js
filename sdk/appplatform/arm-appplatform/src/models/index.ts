 ...
 * Certificate resource payload.
 */
export interface CertificateResource extends Resource {
  /**
...
export interface CertificateResourceCollection {
   ...
   */
  resources?: CertificateResourceCollection[];
  /**
 ...
 */
export interface CustomDomainResource extends Resource {
  /**
...
/**
 * Contains response data for the getAsync operation.
 */
export type CertificateGetAsyncResponse = CertificateResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
...
/**
 * Contains response data for the createOrUpdateAsync operation.
 */
export type CertificateCreateOrUpdateAsyncResponse = CertificateResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
...
/**
 * Contains response data for the deleteAsync operation.
 */
export type CertificateDeleteAsyncResponse = CertificateResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
...
/**
 * Contains response data for the listAsync operation.
 */
export type CertificateListAsyncResponse = CertificateResourceCollection & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
...
/**
 * Contains response data for the beginCreateOrUpdateAsync operation.
 */
export type CertificateBeginCreateOrUpdateAsyncResponse = CertificateResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the getAsync operation.
 */
export type CustomDomainsGetAsyncResponse = CustomDomainResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the createOrUpdateAsync operation.
 */
export type CustomDomainsCreateOrUpdateAsyncResponse = CustomDomainResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the deleteAsync operation.
 */
export type CustomDomainsDeleteAsyncResponse = CustomDomainResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
...
/**
 * Contains response data for the patchAsync operation.
 */
export type CustomDomainsPatchAsyncResponse = CustomDomainResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listAsync operation.
 */
export type CustomDomainsListAsyncResponse = CustomDomainResourceCollection & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdateAsync operation.
 */
export type CustomDomainsBeginCreateOrUpdateAsyncResponse = CustomDomainResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
