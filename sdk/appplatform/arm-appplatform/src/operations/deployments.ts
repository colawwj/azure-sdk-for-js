...
export class Deployments {
   ...
   * @param deploymentName The name of the Deployment resource.
   * @param [options] The optional parameters
   * @returns Promise<Models.DeploymentsGetSkusResponse>
   */
  getSkus(resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, options?: msRest.RequestOptionsBase): Promise<Models.DeploymentsGetSkusResponse>;
  /**
   * @param resourceGroupName The name of the resource group that contains the resource. You can
   * obtain this value from the Azure Resource Manager API or the portal.
   * @param serviceName The name of the Service resource.
   ...
   * @param callback The callback
   */
  getSkus(resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, callback: msRest.ServiceCallback<Models.AutoScaleSkuCollection>): void;
  /**
   * @param resourceGroupName The name of the resource group that contains the resource. You can
   * obtain this value from the Azure Resource Manager API or the portal.
   * @param serviceName The name of the Service resource.
   ...
   * @param callback The callback
   */
  getSkus(resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.AutoScaleSkuCollection>): void;
  getSkus(resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.AutoScaleSkuCollection>, callback?: msRest.ServiceCallback<Models.AutoScaleSkuCollection>): Promise<Models.DeploymentsGetSkusResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        serviceName,
      ...
      getSkusOperationSpec,
      callback) as Promise<Models.DeploymentsGetSkusResponse>;
  }
...
const getSkusOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
  path: "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/apps/{appName}/deployments/{deploymentName}/skus",
  urlParameters: [
    Parameters.subscriptionId,
    Parameters.resourceGroupName,
    Parameters.serviceName,
  ...
  responses: {
    200: {
      bodyMapper: Mappers.AutoScaleSkuCollection
    },
    default: {
      bodyMapper: Mappers.CloudError
    }
