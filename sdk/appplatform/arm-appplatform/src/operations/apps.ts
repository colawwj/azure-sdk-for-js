...
export class Apps {
   ...
   */
  update(appResource: Models.AppResource, resourceGroupName: string, serviceName: string, appName: string, options?: msRest.RequestOptionsBase): Promise<Models.AppsUpdateResponse> {
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginUpdate(appResource: Models.AppResource, resourceGroupName: string, serviceName: string, appName: string, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        appResource,
        resourceGroupName,
