...
export class MarketplaceAgreements {
   ...
   * @param callback The callback
   */
  create(callback: msRest.ServiceCallback<Models.DatadogAgreementResource>): void;
  /**
   * @param options The optional parameters
   * @param callback The callback
   */
  create(options: Models.MarketplaceAgreementsCreateOptionalParams, callback: msRest.ServiceCallback<Models.DatadogAgreementResource>): void;
  create(options?: Models.MarketplaceAgreementsCreateOptionalParams | msRest.ServiceCallback<Models.DatadogAgreementResource>, callback?: msRest.ServiceCallback<Models.DatadogAgreementResource>): Promise<Models.MarketplaceAgreementsCreateResponse> {
    return this.client.sendOperationRequest(
      {
        options
      },
