 ...
 * Optional Parameters.
 */
export interface ApiKeysSetDefaultKeyOptionalParams extends msRest.RequestOptionsBase {
  body?: DatadogApiKey;
}
 ...
 */
export type MarketplaceAgreementsCreateResponse = DatadogAgreementResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the list operation.
 */
export type ApiKeysListResponse = DatadogApiKeyListResponse & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type ApiKeysGetDefaultKeyResponse = DatadogApiKey & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listNext operation.
 */
export type ApiKeysListNextResponse = DatadogApiKeyListResponse & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the list operation.
 */
export type HostsListResponse = DatadogHostListResponse & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listNext operation.
 */
export type HostsListNextResponse = DatadogHostListResponse & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the list operation.
 */
export type LinkedResourcesListResponse = LinkedResourceListResponse & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listNext operation.
 */
export type LinkedResourcesListNextResponse = LinkedResourceListResponse & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the get operation.
 */
export type RefreshSetPasswordGetResponse = DatadogSetPasswordLink & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
