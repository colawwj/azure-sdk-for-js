...
export interface RedisCommonPropertiesRedisConfiguration {
  /**
   * Specifies whether the resource has RDB export enabled. Premium tier only.
   */
  rdbBackupEnabled?: boolean;
  /**
   * Specifies the connection string to the Storage account for Redis data persistence. Premium
   * tier only.
   */
  rdbStorageConnectionString?: string;
  /**
   * Specifies the backup frequency for Redis data persistence. Premium tier only.
   */
  ...
  /**
   * Configures memory optimization for small aggregate data types. Standard and Premium tiers.
   */
  ...
  /**
   * Configures the number of databases. This property can be configured only at cache creation.
