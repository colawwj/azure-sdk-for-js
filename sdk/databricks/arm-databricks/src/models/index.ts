...
export interface ManagedIdentityConfiguration {
  ...
  /**
   * User assigned identity that will be used for Customer Managed Key Encryption while accessing
   * Key Vault.
   */
  identity?: string;
  /**
   * The type of Identity created. It can be either SystemAssigned or UserAssigned. Possible values
...
export interface Identity {
  /**
   * The type of identity for workspace. The type 'None' will remove any identities assigned to
   * workspace. Possible values include: 'UserAssigned', 'None'
   */
