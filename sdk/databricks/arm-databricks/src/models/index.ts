...
/**
 * Details of the keyvault from which to fetch the encryption keys
 */
export interface ManagedServicesEncryptionEntitiesManagedServicesKeyVaultProperties {
  /**
   * The Uri of KeyVault.
   */
  keyVaultUri: string;
...
/**
 * Identity used to access the secret from the keyvault for encryption.
 */
export interface ManagedServicesEncryptionEntitiesManagedServicesIdentity {
  /**
   * The type of identity to be used. Possible values include: 'None', 'UserAssigned'
   */
  type: Type;
  /**
   * The resource id of the identity to be used.
   */
  identity?: string;
}

/**
 * Encryption details for managed services
 */
export interface ManagedServicesEncryptionEntitiesManagedServices {
  /**
   ...
   * Details of the keyvault from which to fetch the encryption keys
   */
  keyVaultProperties?: ManagedServicesEncryptionEntitiesManagedServicesKeyVaultProperties;
  /**
   * Identity used to access the secret from the keyvault for encryption.
   */
  identity?: ManagedServicesEncryptionEntitiesManagedServicesIdentity;
}

/**
 * Provides the details for the encryption of the entities owned by the service. E.g: notebooks.
 */
export interface ManagedServicesEncryptionEntities {
  /**
   * Encryption details for managed services
   */
  managedServices?: ManagedServicesEncryptionEntitiesManagedServices;
}
...
export interface WorkspaceEncryptionParameter {
   ...
   * The value which should be used for this field
   */
  entities?: ManagedServicesEncryptionEntities;
  /**
   * The value which should be used for this field.
   */
  value?: Encryption;
 ...
 * @enum {string}
 */
export type Type = 'None' | 'UserAssigned';
