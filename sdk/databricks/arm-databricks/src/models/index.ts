...
export interface Workspace extends TrackedResource {
  ...
  /**
   * Gets or sets a value indicating data plane to control plane communication. Possible values are
   * 'AllRules' and 'NoAzureDatabricksRules'. Possible values include: 'AllRules',
 ...
 * Possible values include: 'AllRules', 'NoAzureDatabricksRules'
 * @readonly
 * @enum {string}
 */
export type RequiredNsgRules = 'AllRules' | 'NoAzureDatabricksRules';
