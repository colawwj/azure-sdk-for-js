...
export const TargetPortalGroupCreate: msRest.CompositeMapper = {
  serializedName: "TargetPortalGroupCreate",
  type: {
    name: "Composite",
    className: "TargetPortalGroupCreate",
    modelProperties: {
      luns: {
        required: true,
        serializedName: "luns",
...
export const TargetPortalGroupUpdate: msRest.CompositeMapper = {
  serializedName: "TargetPortalGroupUpdate",
  type: {
    name: "Composite",
    className: "TargetPortalGroupUpdate",
    modelProperties: {
      luns: {
        serializedName: "luns",
        type: {
