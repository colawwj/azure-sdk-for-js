...
export interface SecurityProfile {
  ...
  /**
   * Specifies the SecurityType of the VM. It is set as SecureBoot for TrustedVMs, and
   * MemoryEncryption for Confidential VMs. <br><br> Default: The SecurityType would not be set for
   * other VMs. Possible values include: 'SecureBoot', 'MemoryEncryption'
   */
 ...
 * Possible values include: 'SecureBoot', 'MemoryEncryption'
 * @readonly
 * @enum {string}
 */
export type SecurityTypes = 'SecureBoot' | 'MemoryEncryption';
