...
export interface VirtualMachineInstallPatchesParameters {
   ...
   * values include: 'Unknown', 'IfRequired', 'Never', 'Always'
   */
...
export interface VMGalleryApplication {
  ...
  tags?: string;
  /**
   * Optional, Specifies the order in which the packages have to be installed, has no effect if
   * manuallyManaged is set to true
   */
  order?: number;
  /**
   * Specifies whether the gallery application would be manually managed. If set to true, the
   * VMApplicationExtension would not manage the gallery application. Default value: false.
   */
...
export interface SecurityProfile {
  ...
  /**
   * Specifies the SecurityType of the virtual machine. It is set as SecureBoot to enable
   * UefiSettings. <br><br> Default: UefiSettings will not be enabled unless this property is set
   * as SecureBoot. Possible values include: 'SecureBoot'
   */
 ...
 */
export interface WindowsPatchSettings {
  /**
...
export interface WindowsConfiguration {
   ...
   * Specifies settings related to VM Guest Patching on Windows.
   */
  patchSettings?: WindowsPatchSettings;
  /**
 ...
 * Optional Parameters.
 */
export interface VirtualMachinesInstallPatchesOptionalParams extends msRest.RequestOptionsBase {
  /**
   * Input for InstallPatches as directly received by the API
   */
 ...
 * Optional Parameters.
 */
export interface VirtualMachinesBeginInstallPatchesOptionalParams extends msRest.RequestOptionsBase {
  /**
   * Input for InstallPatches as directly received by the API
   */
  installPatchesInput?: VirtualMachineInstallPatchesParameters;
 ...
 * Possible values include: 'Unknown', 'IfRequired', 'Never', 'Always'
 * @readonly
 * @enum {string}
 */
export type VMGuestPatchRebootSetting = 'Unknown' | 'IfRequired' | 'Never' | 'Always';

/**
 * Defines values for VMGuestPatchClassificationWindows.
 * Possible values include: 'Unknown', 'Critical', 'Security', 'UpdateRollUp', 'FeaturePack',
 * 'ServicePack', 'Definition', 'Tools', 'Updates'
 * @readonly
 * @enum {string}
 */
export type VMGuestPatchClassificationWindows = 'Unknown' | 'Critical' | 'Security' | 'UpdateRollUp' | 'FeaturePack' | 'ServicePack' | 'Definition' | 'Tools' | 'Updates';

/**
 * Defines values for VMGuestPatchClassificationLinux.
 * Possible values include: 'Unknown', 'Critical', 'Security', 'Other'
 * @readonly
 * @enum {string}
 */
export type VMGuestPatchClassificationLinux = 'Unknown' | 'Critical' | 'Security' | 'Other';
 ...
 * @enum {string}
 */
export type VMGuestPatchRebootStatus = 'NotNeeded' | 'Required' | 'Started' | 'Failed' | 'Completed';
 ...
 * Possible values include: 'SecureBoot'
 * @readonly
 * @enum {string}
 */
export type SecurityTypes = 'SecureBoot';
