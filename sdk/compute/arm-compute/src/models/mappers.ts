...
export const VMGalleryApplication: msRest.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...
      manuallyManaged: {
        serializedName: "manuallyManaged",
        defaultValue: false,
        type: {
          name: "Boolean"
        }
...
export const WindowsPatchSettings: msRest.CompositeMapper = {
  serializedName: "WindowsPatchSettings",
  type: {
    name: "Composite",
    className: "WindowsPatchSettings",
    modelProperties: {
      patchMode: {
