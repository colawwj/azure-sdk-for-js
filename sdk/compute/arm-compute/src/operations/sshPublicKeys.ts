...
export class SshPublicKeys {
   ...
   */
  update(resourceGroupName: string, sshPublicKeyName: string, parameters: Models.SshPublicKeyResource, options?: msRest.RequestOptionsBase): Promise<Models.SshPublicKeysUpdateResponse>;
  /**
   * @param resourceGroupName The name of the resource group.
   * @param sshPublicKeyName The name of the SSH public key.
   * @param parameters Parameters supplied to update the SSH public key.
   * @param callback The callback
   */
  update(resourceGroupName: string, sshPublicKeyName: string, parameters: Models.SshPublicKeyResource, callback: msRest.ServiceCallback<Models.SshPublicKeyResource>): void;
  /**
   * @param resourceGroupName The name of the resource group.
   * @param sshPublicKeyName The name of the SSH public key.
   * @param parameters Parameters supplied to update the SSH public key.
   ...
   * @param callback The callback
   */
  update(resourceGroupName: string, sshPublicKeyName: string, parameters: Models.SshPublicKeyResource, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.SshPublicKeyResource>): void;
  update(resourceGroupName: string, sshPublicKeyName: string, parameters: Models.SshPublicKeyResource, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.SshPublicKeyResource>, callback?: msRest.ServiceCallback<Models.SshPublicKeyResource>): Promise<Models.SshPublicKeysUpdateResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        sshPublicKeyName,
