...
export class VirtualMachines {
   ...
   */
  installPatches(resourceGroupName: string, vmName: string, options?: Models.VirtualMachinesInstallPatchesOptionalParams): Promise<Models.VirtualMachinesInstallPatchesResponse> {
    return this.beginInstallPatches(resourceGroupName,vmName,options)
      .then(lroPoller => lroPoller.pollUntilFinished()) as Promise<Models.VirtualMachinesInstallPatchesResponse>;
  }
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginInstallPatches(resourceGroupName: string, vmName: string, options?: Models.VirtualMachinesBeginInstallPatchesOptionalParams): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        resourceGroupName,
        vmName,
...
const beginInstallPatchesOperationSpec: msRest.OperationSpec = {
  ...
  requestBody: {
    ...
    mapper: Mappers.VirtualMachineInstallPatchesParameters
  },
  responses: {
    200: {
